...
public static class WindowsUserNative
{
    // Fields
    ...
    public static int WM_MOUSEENTER
    {
        get
        {
            ...
            {
                wmMouseEnterMessage = WindowsKernalNativeSafe.RegisterWindowMessage("WinFormsMouseEnter");
            }
    ...
    public static int WM_UIUNSUBCLASS
    {
        get
        {
            if (wmUnSubclass == -1)
            {
                wmUnSubclass = WindowsKernalNativeSafe.RegisterWindowMessage("WinFormsUnSubclass");
            }
            return wmUnSubclass;
        }
    }
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.CHARFORMAT2A));
        public int dwMask;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.CHARFORMATA));
        public int dwMask;
        public int dwEffects;
        public int yHeight;
        public int yOffset;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.CHARFORMATW));
        public int dwMask;
        public int dwEffects;
        public int yHeight;
        public int yOffset;
    ...
    {
        public int lStructSize = Marshal.SizeOf(typeof(WindowsUserNative.CHOOSECOLOR));
        ...
        public WindowsUserNative.WndProc lpfnHook;
    ...
    {
        public int lStructSize = Marshal.SizeOf(typeof(WindowsUserNative.CHOOSEFONT));
        public IntPtr hwndOwner;
        public IntPtr hDC;
    ...
    public class COMRECT
    {
        ...
        public static WindowsUserNative.COMRECT FromXYWH(int x, int y, int width, int height)
        {
            return new WindowsUserNative.COMRECT(x, y, x + width, y + height);
        }
    ...
    public class DOCHOSTUIINFO
    {
        ...
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.DOCHOSTUIINFO));
    ...
    public class DRAWITEMSTRUCT
    {
        ...
        public WindowsUserNative.RECT rcItem;
    ...
    public class EDITSTREAM
    {
        ...
        public int dwError;
        public WindowsUserNative.EditStreamCallback pfnCallback;
    }
    ...
    {
        public WindowsUserNative.NMHDR nmhdr;
    ...
    public class ENLINK
    {
        ...
        public WindowsUserNative.CHARRANGE charrange;
    }
    ...
    public class ENPROTECTED
    {
        ...
        public WindowsUserNative.CHARRANGE chrg;
    }
    ...
    {
        public int cbSizeOfStruct = Marshal.SizeOf(typeof(WindowsUserNative.FONTDESC));
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.HELPINFO));
        public int iContextType;
        public int iCtrlId;
        public IntPtr hItemHandle = IntPtr.Zero;
        public int dwContextId;
        public WindowsUserNative.POINT MousePos;
    }

    [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Auto)]
    public class HH_AKLINK
    {
        internal int cbStruct = Marshal.SizeOf(typeof(WindowsUserNative.HH_AKLINK));
    ...
    {
        internal int cbStruct = Marshal.SizeOf(typeof(WindowsUserNative.HH_FTS_QUERY));
    ...
    {
        internal int cbStruct = Marshal.SizeOf(typeof(WindowsUserNative.HH_POPUP));
        internal IntPtr hinst = IntPtr.Zero;
        internal int idString;
        internal IntPtr pszText;
        internal WindowsUserNative.POINT pt;
        internal int clrForeground = -1;
        internal int clrBackground = -1;
        internal WindowsUserNative.RECT rcMargins = WindowsUserNative.RECT.FromXYWH(-1, -1, -1, -1);
    ...
    [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("4D07FC10-F931-11CE-B001-00AA006884E5")]
    ...
    [Guid("626FC520-A41E-11CF-A731-00A0C9082637"), InterfaceType(ComInterfaceType.InterfaceIsDual), ComVisible(true)]
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.IMAGELISTDRAWPARAMS));
    ...
    {
        public int type;
        public WindowsUserNative.INPUTUNION inputUnion;
    }
    ...
    public struct INPUTUNION
    {
        // Fields
        [FieldOffset(0)]
        public WindowsUserNative.HARDWAREINPUT hi;
        [FieldOffset(0)]
        public WindowsUserNative.KEYBDINPUT ki;
        [FieldOffset(0)]
        public WindowsUserNative.MOUSEINPUT mi;
    }

    [ComImport, ComVisible(true), Guid("B722BCCB-4E68-101B-A2BC-00AA00404770"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public interface IOleCommandTarget
    {
        [return: MarshalAs(UnmanagedType.I4)]
        [PreserveSig]
        int QueryStatus(ref Guid pguidCmdGroup, int cCmds, [In, Out] WindowsUserNative.OLECMD prgCmds, [In, Out] IntPtr pCmdText);
        [return: MarshalAs(UnmanagedType.I4)]
        [PreserveSig]
    ...
    [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("B196B28B-BAB4-101A-B69C-00AA00341D07")]
    public interface ISpecifyPropertyPages
    {
        void GetPages([Out] WindowsUserNative.tagCAUUID pPages);
    }
    ...
    public class LOGFONT
    {
        ...
        public LOGFONT(WindowsUserNative.LOGFONT lf)
        {
    ...
    {
        public uint cbSize = ((uint) Marshal.SizeOf(typeof(WindowsUserNative.LVGROUP)));
        public uint mask;
    ...
    {
        public uint cbSize = ((uint) Marshal.SizeOf(typeof(WindowsUserNative.LVINSERTMARK)));
        public int dwFlags;
        public int iItem;
        public int dwReserved;
    }
    ...
    {
        public uint cbSize = ((uint) Marshal.SizeOf(typeof(WindowsUserNative.LVTILEVIEWINFO)));
        public int dwMask;
        public int dwFlags;
        public WindowsUserNative.SIZE sizeTile;
        public int cLines;
        public WindowsUserNative.RECT rcLabelMargin;
    }
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.MCHITTESTINFO));
        public int pt_x;
        public int pt_y;
        public int uHit;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.MENUITEMINFO_T));
        public int fMask;
        public int fType;
        public int fState;
        public int wID;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.MENUITEMINFO_T_RW));
        public int fMask;
        public int fType;
        public int fState;
        public int wID;
    ...
    {
        public WindowsUserNative.POINT ptReserved;
        public WindowsUserNative.POINT ptMaxSize;
        public WindowsUserNative.POINT ptMaxPosition;
        public WindowsUserNative.POINT ptMinTrackSize;
        public WindowsUserNative.POINT ptMaxTrackSize;
    }
    ...
    {
        internal int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.MONITORINFO));
        internal WindowsUserNative.RECT rcMonitor = new WindowsUserNative.RECT();
        internal WindowsUserNative.RECT rcWork = new WindowsUserNative.RECT();
    ...
    {
        internal int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.MONITORINFOEX));
        internal WindowsUserNative.RECT rcMonitor = new WindowsUserNative.RECT();
        internal WindowsUserNative.RECT rcWork = new WindowsUserNative.RECT();
        internal int dwFlags;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=0x20)]
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.MSOCRINFOSTRUCT));
    ...
    {
        public WindowsUserNative.NMHDR nmcd;
        public int dwDrawStage;
        public IntPtr hdc;
        public WindowsUserNative.RECT rc;
    ...
    public class NMDATETIMECHANGE
    {
        public WindowsUserNative.NMHDR nmhdr;
        public int dwFlags;
        public WindowsUserNative.SYSTEMTIME st;
    }
    ...
    {
        public WindowsUserNative.NMHDR nmhdr;
        public WindowsUserNative.SYSTEMTIME stStart;
    ...
    {
        public WindowsUserNative.NMHDR hdr;
        public int iItem;
        public int iSubItem;
    ...
    {
        public WindowsUserNative.NMCUSTOMDRAW nmcd;
        public int clrText;
        ...
        public int iPartId;
        public int iStateId;
        public WindowsUserNative.RECT rcText;
        public uint uAlign;
    }
    ...
    {
        public WindowsUserNative.NMHDR hdr;
        public WindowsUserNative.LVITEM item;
    }
    ...
    {
        public WindowsUserNative.NMHDR hdr;
        public WindowsUserNative.LVITEM_NOTEXT item;
    }
    ...
    public struct NMLVFINDITEM
    {
        public WindowsUserNative.NMHDR hdr;
        public int iStart;
        public WindowsUserNative.LVFINDINFO lvfi;
    }
    ...
    {
        public WindowsUserNative.NMHDR nmhdr;
        public WindowsUserNative.SYSTEMTIME stSelStart;
        public WindowsUserNative.SYSTEMTIME stSelEnd;
    }
    ...
    public struct NMTOOLBAR
    {
        public WindowsUserNative.NMHDR hdr;
        public int iItem;
        public WindowsUserNative.TBBUTTON tbButton;
        public int cchText;
        public IntPtr pszText;
    }
    ...
    public struct NMTREEVIEW
    {
        public WindowsUserNative.NMHDR nmhdr;
        public int action;
        public WindowsUserNative.TV_ITEM itemOld;
        public WindowsUserNative.TV_ITEM itemNew;
        public int ptDrag_X;
        public int ptDrag_Y;
    }
    ...
    {
        public WindowsUserNative.NMHDR hdr;
        public WindowsUserNative.TV_ITEM item;
    }
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.NONCLIENTMETRICS));
        ...
        public WindowsUserNative.LOGFONT lfCaptionFont;
        public int iSmCaptionWidth;
        public int iSmCaptionHeight;
        [MarshalAs(UnmanagedType.Struct)]
        public WindowsUserNative.LOGFONT lfSmCaptionFont;
        public int iMenuWidth;
        public int iMenuHeight;
        [MarshalAs(UnmanagedType.Struct)]
        public WindowsUserNative.LOGFONT lfMenuFont;
        [MarshalAs(UnmanagedType.Struct)]
        public WindowsUserNative.LOGFONT lfStatusFont;
        [MarshalAs(UnmanagedType.Struct)]
        public WindowsUserNative.LOGFONT lfMessageFont;
    }

    [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Auto)]
    public class NOTIFYICONDATA
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.NOTIFYICONDATA));
        public IntPtr hWnd;
        public int uID;
        public int uFlags;
    ...
    {
        public int cbSizeOfStruct = Marshal.SizeOf(typeof(WindowsUserNative.OCPFIPARAMS));
        public IntPtr hwndOwner;
        public int x;
        public int y;
    ...
    {
        public int lStructSize = Marshal.SizeOf(typeof(WindowsUserNative.OPENFILENAME_I));
        public IntPtr hwndOwner;
        public IntPtr hInstance;
    ...
    public class PAGESETUPDLG
    {
        ...
        public IntPtr lCustData = IntPtr.Zero;
        public WindowsUserNative.WndProc lpfnPageSetupHook;
        public WindowsUserNative.WndProc lpfnPagePaintHook;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.PARAFORMAT));
        public int dwMask;
    ...
    public class PRINTDLG
    {
        ...
        public WindowsUserNative.WndProc lpfnPrintHook;
        public WindowsUserNative.WndProc lpfnSetupHook;
    ...
    public class PRINTDLGEX
    {
        ...
        [MarshalAs(UnmanagedType.LPStr)]
        public string lpPrintTemplateName;
        public WindowsUserNative.WndProc lpCallback;
    ...
    public struct RECT
    {
        ...
        public static WindowsUserNative.RECT FromXYWH(int x, int y, int width, int height)
        {
            return new WindowsUserNative.RECT(x, y, x + width, y + height);
        }
    ...
    public class SCROLLINFO
    {
        ...
        public SCROLLINFO()
        {
            this.cbSize = Marshal.SizeOf(typeof(WindowsUserNative.SCROLLINFO));
        }
    ...
    {
        [MarshalAs(UnmanagedType.U4)]
        public int cb = Marshal.SizeOf(typeof(WindowsUserNative.tagCONTROLINFO));
    ...
    {
        public WindowsUserNative.tagTYPEDESC tdesc;
        public WindowsUserNative.tagPARAMDESC paramdesc;
    }
    ...
    {
        public int cbSizeofstruct = Marshal.SizeOf(typeof(WindowsUserNative.tagFONTDESC));
        [MarshalAs(UnmanagedType.LPWStr)]
        public string lpstrName;
    ...
    public sealed class tagFUNCDESC
    {
        ...
        public WindowsUserNative.value_tagELEMDESC elemdescFunc;
        [MarshalAs(UnmanagedType.U2)]
    ...
    {
        [MarshalAs(UnmanagedType.U4)]
        public int cbLicInfo = Marshal.SizeOf(typeof(WindowsUserNative.tagLICINFO));
    ...
    public sealed class tagTYPEATTR
    {
        ...
        public WindowsUserNative.tagTYPEDESC Get_tdescAlias()
        {
            WindowsUserNative.tagTYPEDESC gtypedesc = new WindowsUserNative.tagTYPEDESC();
            gtypedesc.unionMember = (IntPtr) this.tdescAlias_unionMember;
            gtypedesc.vt = this.tdescAlias_vt;
            return gtypedesc;
        }

        public WindowsUserNative.tagIDLDESC Get_idldescType()
        {
            WindowsUserNative.tagIDLDESC gidldesc = new WindowsUserNative.tagIDLDESC();
            gidldesc.dwReserved = this.idldescType_dwReserved;
            gidldesc.wIDLFlags = this.idldescType_wIDLFlags;
            return gidldesc;
        }
    }
    ...
    public sealed class tagVARDESC
    {
        ...
        public WindowsUserNative.value_tagELEMDESC elemdescVar;
        [MarshalAs(UnmanagedType.U2)]
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.TOOLINFO_T));
        public int uFlags;
        public IntPtr hwnd;
        public IntPtr uId;
        public WindowsUserNative.RECT rect;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.TOOLINFO_TOOLTIP));
        public int uFlags;
        public IntPtr hwnd;
        public IntPtr uId;
        public WindowsUserNative.RECT rect;
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.TPMPARAMS));
    ...
    {
        public int cbSize = Marshal.SizeOf(typeof(WindowsUserNative.TRACKMOUSEEVENT));
        public int dwFlags;
    ...
    {
        public IntPtr hParent;
        public WindowsUserNative.TreeViewCompareCallback lpfnCompare;
        public IntPtr lParam;
    }
    ...
    {
        public int style;
        public WindowsUserNative.WndProc lpfnWndProc;
...
internal static class WindowsUserNativeSafe
{
   // Methods
   [DllImport("comctl32.dll", ExactSpelling = true)]
   private static extern bool _TrackMouseEvent(WindowsUserNative.TRACKMOUSEEVENT tme);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern IntPtr ActivateKeyboardLayout(HandleRef hkl, int uFlags);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool AdjustWindowRectEx(ref WindowsUserNative.RECT lpRect, int dwStyle, bool bMenu, int dwExStyle);
   ...
   public static extern bool ChooseColor([In, Out] WindowsUserNative.CHOOSECOLOR cc);
   [DllImport("comdlg32.dll", CharSet = CharSet.Auto, SetLastError = true)]
   public static extern bool ChooseFont([In, Out] WindowsUserNative.CHOOSEFONT cf);
   ...
   public static extern int DoDragDrop(IDataObject dataObject, IOleDropSource dropSource, int allowedEffects, int[] finalEffect);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool DrawEdge(HandleRef hDC, ref WindowsUserNative.RECT rect, int edge, int flags);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool DrawFrameControl(HandleRef hDC, ref WindowsUserNative.RECT rect, int type, int state);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   ...
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int DrawThemeBackground(HandleRef hTheme, HandleRef hdc, int partId, int stateId, [In] WindowsUserNative.COMRECT pRect, [In] WindowsUserNative.COMRECT pClipRect);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int DrawThemeEdge(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [In] WindowsUserNative.COMRECT pDestRect, int uEdge, int uFlags, [Out] WindowsUserNative.COMRECT pContentRect);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int DrawThemeParentBackground(HandleRef hwnd, HandleRef hdc, [In] WindowsUserNative.COMRECT prc);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int DrawThemeText(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [MarshalAs(UnmanagedType.LPWStr)] string pszText, int iCharCount, int dwTextFlags, int dwTextFlags2, [In] WindowsUserNative.COMRECT pRect);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool EnableWindow(HandleRef hWnd, bool enable);
   [DllImport("user32.dll", ExactSpelling = true)]
   public static extern bool EnumDisplayMonitors(HandleRef hdc, WindowsUserNative.COMRECT rcClip, WindowsUserNative.MonitorEnumProc lpfnEnum, IntPtr dwData);
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   public static extern bool EnumDisplaySettings(string lpszDeviceName, int iModeNum, ref WindowsUserNative.DEVMODE lpDevMode);
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern int FillRect(HandleRef hdc, [In] ref WindowsUserNative.RECT rect, HandleRef hbrush);
   [DllImport("kernel32.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool GetClientRect(HandleRef hWnd, [In, Out] ref WindowsUserNative.RECT rect);
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   public static extern int GetClipboardFormatName(int format, StringBuilder lpString, int cchMax);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool GetClipCursor([In, Out] ref WindowsUserNative.RECT lpRect);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   ...
   [DllImport("gdi32.dll")]
   public static extern int GetDIBits(HandleRef hdc, HandleRef hbm, int uStartScan, int cScanLines, byte[] lpvBits, ref WindowsUserNative.BITMAPINFO_FLAT bmi, int uUsage);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool GetIconInfo(HandleRef hIcon, [In, Out] WindowsUserNative.ICONINFO info);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   public static extern bool GetMonitorInfo(HandleRef hmonitor, [In, Out] WindowsUserNative.MONITORINFOEX info);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern int GetPaletteEntries(HandleRef hpal, int iStartIndex, int nEntries, int[] lppe);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern int GetRgnBox(HandleRef hRegion, ref WindowsUserNative.RECT clipRect);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool GetScrollInfo(HandleRef hWnd, int fnBar, [In, Out] WindowsUserNative.SCROLLINFO si);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   ...
   public static int GetTextMetrics(HandleRef hDC, ref WindowsUserNative.TEXTMETRIC lptm)
   {
      if (Marshal.SystemDefaultCharSize == 1)
      {
         WindowsUserNative.TEXTMETRICA textmetrica = new WindowsUserNative.TEXTMETRICA();
   ...
   public static extern int GetTextMetricsA(HandleRef hDC, [In, Out] ref WindowsUserNative.TEXTMETRICA lptm);
   [DllImport("gdi32.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
   public static extern int GetTextMetricsW(HandleRef hDC, [In, Out] ref WindowsUserNative.TEXTMETRIC lptm);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeAppProperties();
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeBackgroundContentRect(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [In] WindowsUserNative.COMRECT pBoundingRect, [Out] WindowsUserNative.COMRECT pContentRect);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeBackgroundExtent(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [In] WindowsUserNative.COMRECT pContentRect, [Out] WindowsUserNative.COMRECT pExtentRect);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeBackgroundRegion(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [In] WindowsUserNative.COMRECT pRect, ref IntPtr pRegion);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeFont(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, int iPropId, WindowsUserNative.LOGFONT pFont);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeInt(HandleRef hTheme, int iPartId, int iStateId, int iPropId, ref int piVal);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeMargins(HandleRef hTheme, HandleRef hDC, int iPartId, int iStateId, int iPropId, ref WindowsUserNative.MARGINS margins);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemePartSize(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [In] WindowsUserNative.COMRECT prc, ThemeSizeType eSize, [Out] WindowsUserNative.SIZE psz);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemePosition(HandleRef hTheme, int iPartId, int iStateId, int iPropId, [Out] WindowsUserNative.POINT pPoint);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int GetThemeTextExtent(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, [MarshalAs(UnmanagedType.LPWStr)] string pszText, int iCharCount, int dwTextFlags, [In] WindowsUserNative.COMRECT pBoundingRect, [Out] WindowsUserNative.COMRECT pExtentRect);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool GetViewportOrgEx(HandleRef hDC, [In, Out] WindowsUserNative.POINT point);
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   public static extern int HitTestThemeBackground(HandleRef hTheme, HandleRef hdc, int iPartId, int iStateId, int dwOptions, [In] WindowsUserNative.COMRECT pRect, HandleRef hrgn, [In] WindowsUserNative.POINTSTRUCT ptTest, ref int pwHitTestCode);
   ...
   [DllImport("hhctrl.ocx", CharSet = CharSet.Auto)]
   public static extern int HtmlHelp(HandleRef hwndCaller, [MarshalAs(UnmanagedType.LPTStr)] string pszFile, int uCommand, [MarshalAs(UnmanagedType.LPStruct)] WindowsUserNative.HH_AKLINK dwData);
   [DllImport("hhctrl.ocx", CharSet = CharSet.Auto)]
   public static extern int HtmlHelp(HandleRef hwndCaller, [MarshalAs(UnmanagedType.LPTStr)] string pszFile, int uCommand, [MarshalAs(UnmanagedType.LPStruct)] WindowsUserNative.HH_FTS_QUERY dwData);
   [DllImport("hhctrl.ocx", CharSet = CharSet.Auto)]
   public static extern int HtmlHelp(HandleRef hwndCaller, [MarshalAs(UnmanagedType.LPTStr)] string pszFile, int uCommand, [MarshalAs(UnmanagedType.LPStruct)] WindowsUserNative.HH_POPUP dwData);
   ...
   [DllImport("comctl32.dll")]
   public static extern bool ImageList_GetImageInfo(HandleRef himl, int i, WindowsUserNative.IMAGEINFO pImageInfo);
//   [DllImport("comctl32.dll")]
//   public static extern IntPtr ImageList_Read(UnsafeWindowsUserNative.IStream pstm);
   [DllImport("comctl32.dll")]
...
//   [DllImport("comctl32.dll")]
//   public static extern bool ImageList_Write(HandleRef himl, UnsafeWindowsUserNative.IStream pstm);
//   [DllImport("comctl32.dll")]
//   public static extern int ImageList_WriteEx(HandleRef himl, int dwFlags, UnsafeWindowsUserNative.IStream pstm);
   [DllImport("comctl32.dll")]
   public static extern void InitCommonControls();
   [DllImport("comctl32.dll")]
   public static extern bool InitCommonControlsEx(WindowsUserNative.INITCOMMONCONTROLSEX icc);
   ...
   private static extern IntPtr IntCreateBrushIndirect(WindowsUserNative.LOGBRUSH lb);
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool InvalidateRect(HandleRef hWnd, WindowsUserNative.COMRECT rect, bool erase);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool InvalidateRect(HandleRef hWnd, ref WindowsUserNative.RECT rect, bool erase);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool InvalidateRgn(HandleRef hWnd, HandleRef hrgn, bool erase);
   [DllImport("ole32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool IsAccelerator(HandleRef hAccel, int cAccelEntries, [In] ref WindowsUserNative.MSG lpMsg, short[] lpwCmd);
   [DllImport("uxtheme.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool LPtoDP(HandleRef hDC, [In, Out] ref WindowsUserNative.RECT lpRect, int nCount);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool MessageBeep(int type);
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   public static extern int MessageBox(HandleRef hWnd, string text, string caption, int type);
   [DllImport("user32.dll", ExactSpelling = true)]
   public static extern IntPtr MonitorFromPoint(WindowsUserNative.POINTSTRUCT pt, int flags);
   [DllImport("user32.dll", ExactSpelling = true)]
   public static extern IntPtr MonitorFromRect(ref WindowsUserNative.RECT rect, int flags);
   [DllImport("user32.dll", ExactSpelling = true)]
   public static extern IntPtr MonitorFromWindow(HandleRef handle, int flags);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool MoveToEx(HandleRef hdc, int x, int y, WindowsUserNative.POINT pt);
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool RedrawWindow(HandleRef hwnd, WindowsUserNative.COMRECT rcUpdate, HandleRef hrgnUpdate, int flags);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool RedrawWindow(HandleRef hwnd, ref WindowsUserNative.RECT rcUpdate, HandleRef hrgnUpdate, int flags);
   [DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool ScrollWindow(HandleRef hWnd, int nXAmount, int nYAmount, ref WindowsUserNative.RECT rectScrollRegion, ref WindowsUserNative.RECT rectClip);
   [DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern int ScrollWindowEx(HandleRef hWnd, int nXAmount, int nYAmount, WindowsUserNative.COMRECT rectScrollRegion, ref WindowsUserNative.RECT rectClip, HandleRef hrgnUpdate, ref WindowsUserNative.RECT prcUpdate, int flags);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   ...
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool SetViewportExtEx(HandleRef hDC, int x, int y, WindowsUserNative.SIZE size);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool SetViewportOrgEx(HandleRef hDC, int x, int y, [In, Out] WindowsUserNative.POINT point);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool SetWindowExtEx(HandleRef hDC, int x, int y, [In, Out] WindowsUserNative.SIZE size);
   [DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
   public static extern bool SetWindowOrgEx(HandleRef hDC, int x, int y, [In, Out] WindowsUserNative.POINT point);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   ...
   [DllImport("gdi32.dll")]
   public static extern int StretchDIBits(HandleRef hdc, int XDest, int YDest, int nDestWidth, int nDestHeight, int XSrc, int YSrc, int nSrcWidth, int nSrcHeight, byte[] lpBits, ref WindowsUserNative.BITMAPINFO_FLAT lpBitsInfo, int iUsage, int dwRop);
   [DllImport("oleaut32.dll", CharSet = CharSet.Unicode, ExactSpelling = true)]
   public static extern void SysFreeString(HandleRef bstr);
   public static bool TrackMouseEvent(WindowsUserNative.TRACKMOUSEEVENT tme)
   {
      return _TrackMouseEvent(tme);
   }
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool TrackPopupMenuEx(HandleRef hmenu, int fuFlags, int x, int y, HandleRef hwnd, WindowsUserNative.TPMPARAMS tpm);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool UpdateWindow(HandleRef hWnd);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
   public static extern bool ValidateRect(HandleRef hWnd, [In, Out] ref WindowsUserNative.RECT rect);
   [DllImport("oleaut32.dll", PreserveSig = false)]
...
[SuppressUnmanagedCodeSecurity]
public static class WindowsUserUnsafe
{
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   ...
   [DllImport("user32.dll", CharSet = CharSet.Auto)]
   public static extern IntPtr SetWindowsHookEx(int hookid, Tools.Common.WindowsUserNative.HookProc pfnhook, HandleRef hinst, int threadid);
   [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
...
public static class WindowsKernalNativeSafe
{
   // Fields
   ...
   internal static extern SafeWaitHandle CreateSemaphore( WindowsNative.SECURITY_ATTRIBUTES lpSecurityAttributes, int initialCount, int maximumCount, string name );
   [DllImport( "perfcounter.dll", CharSet = CharSet.Auto )]
   public static extern int FormatFromRawValue( uint dwCounterType, uint dwFormat, ref long pTimeBase, WindowsNative.PDH_RAW_COUNTER pRawValue1, WindowsNative.PDH_RAW_COUNTER pRawValue2, WindowsNative.PDH_FMT_COUNTERVALUE pFmtValue );
   [DllImport( "kernel32.dll", CharSet = CharSet.Auto, SetLastError = true )]
   ...
   [DllImport( "gdi32.dll", CharSet = CharSet.Auto )]
   public static extern bool GetTextMetrics( HandleRef hDC, [In, Out] WindowsNative.TEXTMETRIC tm );
...
public static class WindowsNative
{
    ...
    public class PERF_DATA_BLOCK
    {
        ...
        public WindowsNative.SYSTEMTIME SystemTime;
        public int pad1;
    ...
    public class TokenPrivileges
    {
        ...
        public WindowsNative.LUID Luid;
    ...
    {
        public int style;
        public WindowsNative.WndProc lpfnWndProc;
        public int cbClsExtra;
        public int cbWndExtra;
        public IntPtr hInstance = IntPtr.Zero;
        public IntPtr hIcon = IntPtr.Zero;
...
public sealed class SafeThreadHandle : SafeHandleZeroOrMinusOneIsInvalid
{
   ...
   {
      return WindowsKernalNativeSafe.CloseHandle( base.handle );
   }
}
