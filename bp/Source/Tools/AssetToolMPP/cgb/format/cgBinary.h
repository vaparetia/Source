...
// ** IMPORTANT **   increase CG_BINARY_HEADER_FILE_VERSION on every
//                   (non-trivial) change to this header file.
//                   This variable is used to verify that driver and
//                   the binary 'match'.
//                   [located in CgBinaryProgram::binaryFormatRevision]
...
struct CgBinaryVertexProgram
{
    ...
    unsigned int  userClipMask;             // user clip plane enables (for SET_USER_CLIP_PLANE_CONTROL)
};
...
2006-02-02  Dmitri Makarov  <dmitri_makarov@playstation.sony.com>
Revision 6: Added new parameter attribute isShared, used to mark
	    shared parameters in both VP and FP.
