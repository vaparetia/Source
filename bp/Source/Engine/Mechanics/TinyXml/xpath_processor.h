...
//****************************************************************************
// Added by AndyO.
// Added ENGINE_API exports.
// Fixed const correctness issues.
#include "Engine/BPEEngineAPI.h"
//****************************************************************************

/// Exceptions
#if defined( _PS3 ) || defined( RVL ) || defined( SN_TARGET_PSP2 )
// No exceptions on consoles
#define XPATH_THROW  
#define XPATH_TRY    
#define XPATH_CATCH(x)  if (false)
#else
#define XPATH_THROW  throw
#define XPATH_TRY    try
#define XPATH_CATCH  catch
#endif
...
class ENGINE_API xpath_processor : public xpath_stream
{
public :
   /// Constructor
...
protected :
   ...
   bool o_check_predicate (TiXmlElement const * XEp_child, bool o_by_name);
   ...
   void v_order_tree ();
   void v_order_recurs (TiXmlNode const * Np_base, int & i_current);
   ...
   void v_set_context (TiXmlElement const * XEp_in, bool o_by_name);
