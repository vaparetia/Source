...
// Register factory
static CRegisterEvaluatorFactory sRegisterFactoryCVECircleTangent_vector(gvector3EvaluatorFactoriesEngine, CVECircleTangent_vector::kType_0x825826E8, CVECircleTangent_vector::Factory);

#endif //NO_EVALUATOR_REGISTRATION

#if !defined(NO_EVALUATOR_CONSTRUCTOR)

CVECircleTangent_vector::CVECircleTangent_vector(CEvaluatorAllocator &allocator)
: IVectorEvaluator()
//Start:CVECircleTangent_vector_ctor:E3409ACF:15D54739 *** Machine generated code - do not edit ***
{
//End:CVECircleTangent_vector_ctor:E3409ACF *** Machine generated code - do not edit *** $End$:CVECircleTangent_vector_ctor:E3409ACF
}

CVECircleTangent_vector::~CVECircleTangent_vector()
{
}
...
CVector3 CVECircleTangent_vector::GetValue(CEvaluatorUpdateData const &updateData) const
{
   ...
   CVector3 outPosition((xAxis * -radius * sinf(angle)) + (yAxis * radius * cosf(angle)));
   if (mCenter)
   {
...
//Start:CVECircleTangent_vector_body:3FA9B178:2BB0C2D4 *** Machine generated code - do not edit ***
uint32 const CVECircleTangent_vector::kType_0x825826E8 = 0x825826E8;

#if !defined(NO_EVALUATOR_TYPE)

//----------------------------------------------------------------------------

uint32 CVECircleTangent_vector::GetType() const
{
   return kType_0x825826E8;
}
...
IEvaluator * CVECircleTangent_vector::Factory(CInputStream &inStream, CEvaluatorAllocator &allocator, IEvaluatorFactory const &factory)
{
   CVECircleTangent_vector * pEval = new CVECircleTangent_vector(allocator);
...
void CVECircleTangent_vector::ApplyProperties(CGameObjectApplyPropertiesData &applyProperties, CEvaluatorAllocator &allocator)
{
   ...
   for (int loop = 0; loop < numProperties; loop++)
   {
      ...
      switch (fourCC)
      {
         ...
         default:
            property_load_error_printf( "Unknown property 0x%08x in evaluator loader CVECircleTangent_vector.\n", fourCC );
...
uint32 CVECircleTangent_vector::CopyToLinearStream(CLinearCopyStream &stream, IEvaluatorTypeToVTable const &evalToVTable) const
{
...
void CVECircleTangent_vector::PostLoadUpdate()
{
...
void CVECircleTangent_vector::Initialize(CEvaluatorUpdateData &updateData) const
{
...
//End:CVECircleTangent_vector_body:3FA9B178 *** Machine generated code - do not edit *** $End$:CVECircleTangent_vector_body:3FA9B178
}
