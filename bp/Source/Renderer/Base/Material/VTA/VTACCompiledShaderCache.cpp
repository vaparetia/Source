...
CCompiledShader * CCompiledShaderCache::GetShader(CShaderFileId const &shaderFileId, uint32 const definesCRC, char const * const pDefines)
{
   ...
   if (pCompiledShader == NULL && !sInhibitShaderWarningCount )
   {
