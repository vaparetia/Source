...
{
#ifdef __SNC__
   __builtin_cellAtomicAdd32((unsigned int*)pw, 1);
#else
...
#pragma diag_suppress=68
   return __builtin_cellAtomicAdd32((unsigned int*)pw, -1);
#pragma diag_pop
#else
...
#ifdef __SNC__
        sp_int32_t r2 = __builtin_cellAtomicCompareAndSwap32( (unsigned int*)pw, r, r + 1 );
#else
