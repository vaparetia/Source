...
#define FT_COMPONENT  trace_objs
                ...
                FT_Driver  driver )
  {
    ...
    if ( size->userdata.finalizer )
      size->userdata.finalizer( size );
                ...
                FT_Driver  driver )
  {
    ...
    if ( face->userdata.finalizer )
      face->userdata.finalizer( face );
...
#define FT_COMPONENT  trace_objs
  ...
  Destroy_Module( FT_Module  module )
  {
    ...
    if ( module->userdata.finalizer )
      module->userdata.finalizer( module );
...
#define FREETYPE_VER_FIXED  ( ( (FT_Long)FREETYPE_MAJOR << 16 ) | \
  ...
  FT_Done_Library( FT_Library  library )
  {
    ...
    /* Discard client-data */
    if ( library->userdata.finalizer )
      library->userdata.finalizer( library );
