...
PPU_SRCS		=	main.cpp \
					$(VPSHADER_PPU_OBJS) $(FPSHADER_PPU_OBJS) spu/$(OBJS_DIR)/job_geom.spu.elf spu/$(OBJS_DIR)/job_send_event.spu.elf

PPU_TARGET		=	occluders-sample.$(EDGE_BUILD).ppu.elf
...
PPU_LDLIBS	 	+=	-lusbd_stub -lnet_stub -lio_stub -lm -lstdc++ -lspurs_stub -lgcm_cmd -lgcm_sys_stub -lsysutil_stub -lsysmodule_stub
...
VPSHADER_SRCS	=	vpshader.cg vpdebug.cg
FPSHADER_SRCS	=	fpshader.cg fpdebug.cg
