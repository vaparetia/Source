...
PPU_TARGET	= lzo1x-large-segmented-inflate-sample.$(EDGE_BUILD).ppu.elf

EDGESEGCOMPPPUDIR	= ../lzo1x-segcomp-sample/ppu
...
PPU_LIBS			+= $(EDGE_TARGET_ROOT)/ppu/lib/libedgelzo$(EDGE_BUILD_SUFFIX).a \
                       $(EDGESEGCOMPPPUDIR)/libedgelzo1xsegcomp$(EDGE_BUILD_SUFFIX).a
