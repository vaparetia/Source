...
private:
	...
	CGprogram					mCGVertexProgramSimple;				// CG binary program
	CGprogram					mCGFragmentProgramSimple;				// CG binary program
	void						*mVertexProgramSimpleUCode;			// this is sysmem
	void						*mFragmentProgramSimpleUCode;			// this is vidmem
	uint32_t					mFragmentProgramSimpleOffset;
