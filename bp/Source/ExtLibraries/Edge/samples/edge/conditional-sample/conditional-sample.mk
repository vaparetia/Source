...
PPU_SRCS		=	main.cpp \
					...
					spu/$(OBJS_DIR)/job_geom.spu.elf spu/$(OBJS_DIR)/job_send_event.spu.elf

PPU_TARGET		=	conditional-sample.$(EDGE_BUILD).ppu.elf
...
VPSHADER_SRCS	=	vpshader.cg vpshadersimple.cg
FPSHADER_SRCS	=	fpshader.cg fpshadersimple.cg
