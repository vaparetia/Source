...
PPU_SRCS		+=	spu/$(OBJS_DIR)/job_intersect.spu.elf spu/$(OBJS_DIR)/job_geom.spu.elf spu/$(OBJS_DIR)/job_send_event.spu.elf
PPU_TARGET		=	collision-sample.$(EDGE_BUILD).ppu.elf
