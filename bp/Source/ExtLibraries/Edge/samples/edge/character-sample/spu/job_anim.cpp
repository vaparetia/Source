					  ...
					  uint32_t sizeScratchBuffer)
{
    ...
    edgeAnimLocalJointsToWorldMatrices3x4(outputMatrices, poseLocal.jointArray, rootJoint, skeleton->simdHierarchy, 
...
void cellSpursJobMain2(CellSpursJobContext2* jobContext, CellSpursJob256 *jobAnim)
{
    ...
    // Dma output buffer
    cellDmaLargePut(outputMatrices, eaOutputMatrices, skeleton->numJoints * 48, jobContext->dmaTag, 0, 0);
}
