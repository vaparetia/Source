...
struct JobGeomPerformanceCounters
{
	int32_t m_start;
	int32_t m_initTicks;
	int32_t m_decompressVertexesTicks;
	int32_t m_blendTicks;

	int32_t m_skinTicks;
	int32_t m_decompressIndexesTicks;
	int32_t m_cullTicks;
	int32_t m_allocateTicks;

	int32_t m_outputIndexesTicks;
	int32_t m_compressVertexesTicks;
	int32_t m_outputVertexesTicks;
	int32_t m_outitTicks;

	int32_t m_numInputVertexes;
	int32_t m_numInputIndexes; 
	int32_t m_numOutputVertexes;
	int32_t m_numOutputIndexes;

	int32_t m_padding[4*4];
};
...
typedef struct JobGeom256 {
	...
	struct {
		...
		uint32_t    eaPerformanceCounters;
	} userData;

	// Pad to make it a CellSpursJob256 / 28 bytes
	uint32_t	pad[7];						
