...
EMBEDDED_BINS	=	spu/$(OBJS_DIR)/downsample.spu.bin \
					...
					spu/$(OBJS_DIR)/finalcombine.spu.bin \
					spu/$(OBJS_DIR)/avgluminance.spu.bin
...
PPU_TARGET		=	post-sample-hdr.$(EDGE_BUILD).ppu.elf
...
FPSHADER_SRCS	=	shaders/fpshader.cg \
					shaders/fpsky.cg \
					shaders/tonemap_compositefp.cg \
					shaders/downsample_luvfp.cg \
