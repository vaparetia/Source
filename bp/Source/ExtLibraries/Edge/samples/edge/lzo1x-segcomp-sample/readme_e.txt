...
can then be decompressed by passing the separate segments into Edge LZO in order to retreive the original master file.
...
The "lzo1x-segcomp-sample" program loads the master file and splits it into appropriate sized segments. Each segment is then compressed
...
This sample is used as a building block for other Edge LZO samples.
...
host/edgecompress.cpp                   : Call lzo1x compression
host/edgecompress.h                     : Call lzo1x compression
...
host/lzo1x-segcomp-sample.sln           : Visual Studio solution
host/lzo1x-segcomp-sample.vcproj        : Visual Studio project
host/lzo1x/edgelzo1x_...                : 17 source files for lzo1x compression
host/lzo1x/Makefile                     : Makefile for lzo1x host library compilation
host/lzo1x/lzo1xcompress.sln            : Visual Studio lzo1x solution	
host/lzo1x/lzo1xcompress.vcproj         : Visual Studio lzo1x project
...
host/lzo1x-segcomp-sample.exe           : The MinGW (optimized) version of the segmented compression tool
host/Debug/lzo1x-segcomp-sample.exe     : The Windows Debug (unoptimized) version of the segmented compression tool
host/Release/lzo1x-segcomp-sample.exe   : The Windows Release (optimized) version of the segmented compression tool
host/lzo1x/lzo1xcompress.a              : The MinGW (optimized) library of lzo1x
host/lzo1x/Debug/libcompress.lib        : The Windows Debug (unoptimized) library of lzo1x
host/lzo1x/Release/libcompress.lib      : The Windows Release (optimized) library of lzo1x
...
<Running the Program>
    - Run the lzo1x-segcomp-sample offline tool in order to convert an input file into a segmented compressed file.
