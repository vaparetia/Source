/* edgelzo1x_lzodefs.h -- architecture, OS and compiler specific defines
...
#  define LZO_INFO_CCVER        LZO_CPP_MACRO_EXPAND(_RELEASE)
...
#  if defined(__VER__)
#    define LZO_INFO_CCVER      LZO_CPP_MACRO_EXPAND(__VER__)
#  else
#    define LZO_INFO_CCVER      "unknown"
#  endif
...
#    define LZO_INFO_CCVER      LZO_CPP_MACRO_EXPAND(__SUNPRO_C)
#  else
...
#    define LZO_INFO_CCVER      LZO_CPP_MACRO_EXPAND(__SUNPRO_CC)
#  else
#    define LZO_CC_SUNPROC      1
#    define LZO_INFO_CCVER      "unknown"
#  endif
...
#elif (LZO_ARCH_ALPHA || LZO_ARCH_AMD64 || LZO_ARCH_CRIS || LZO_ARCH_I086 || LZO_ARCH_I386 || LZO_ARCH_MSP430)
