...
PPU_TARGET	= zlib-localmemory-streaming-inflate-sample.$(EDGE_BUILD).ppu.elf
...
PPU_LDLIBS			+= -lspurs_stub -lsync_stub -lsysmodule_stub -lfs_stub -lgcm_cmd -lgcm_sys_stub -lpthread
