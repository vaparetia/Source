...
compressed data in to Edge Zlib to be decompressed by an SPU. However, before doing that it simulates a file read error by
...
<Running the Program>
    - Set fileserving root to the zlib-inflate-retry-sample directory.
