...
/** 
* @brief   Convert local-space joint transforms (R/T/S) to world-space 3x4 matrices (transposed)
...
*
* localRotation =
*          | (0.5 - Rx*Ry - Rz*Rz)   (Rx*Ry - Rw*Rz)         (Rx*Rz + Rw*Ry)         0 |
*          | (Rx*Ry + Rw*Rz)         (0.5 - Rx*Rx - Rz*Rz)   (Ry*Rz - Rw*Rx)         0 |
*          | (Rx*Rz - Rw*Ry)         (Ry*Rz + Rw*Rz)         (0.5 - Rx*Rx - Ry*Ry)   0 |
*
...
*          target/reference/src/edge/anim/edgeanim_local_joints_to_world_matrices3x4.cpp
*
...
void edgeAnimLocalJointsToWorldMatrices3x4(void* outputMatrices,
										   ...
										   unsigned int count)
{
	EDGE_BOOKMARK(EDGE_BOOKMARK_ANIM_LOCAL_JOINTS_TO_WORLD_MATRICES_3X4);
	...
	for(; count4; count4--, linkageInput++) {
		...
		const vec_uint4 jointOfs = spu_add(spu_sl(jointIdx, 4), spu_sl(jointIdx, 5));
		const vec_uint4 jointOfs0 = jointOfs;
		const vec_uint4 jointOfs1 = spu_slqwbyte(jointOfs, 4);
		const vec_uint4 jointOfs2 = spu_slqwbyte(jointOfs, 8);
		const vec_uint4 jointOfs3 = spu_slqwbyte(jointOfs, 12);
		...
		const vec_uint4 parentOfs = spu_sel(spu_add(spu_sl(parentIdx, 4), spu_sl(parentIdx, 5)),(vec_uint4)zero,parentUseRoot);
		const vec_uint4 parentOfs0 = parentOfs;
		const vec_uint4 parentOfs1 = spu_slqwbyte(parentOfs, 4);
		const vec_uint4 parentOfs2 = spu_slqwbyte(parentOfs, 8);
		const vec_uint4 parentOfs3 = spu_slqwbyte(parentOfs, 12);

		// Local Joint Transform Components (lqx)
		const vec_float4 lr0 = *((const vec_float4*) ((uintptr_t) inputBaseR + si_to_uint((vec_char16) jointOfs0)));
		const vec_float4 lr1 = *((const vec_float4*) ((uintptr_t) inputBaseR + si_to_uint((vec_char16) jointOfs1)));
		const vec_float4 lr2 = *((const vec_float4*) ((uintptr_t) inputBaseR + si_to_uint((vec_char16) jointOfs2)));
		const vec_float4 lr3 = *((const vec_float4*) ((uintptr_t) inputBaseR + si_to_uint((vec_char16) jointOfs3)));
		const vec_float4 lt0 = *((const vec_float4*) ((uintptr_t) inputBaseT + si_to_uint((vec_char16) jointOfs0)));
		const vec_float4 lt1 = *((const vec_float4*) ((uintptr_t) inputBaseT + si_to_uint((vec_char16) jointOfs1)));
		const vec_float4 lt2 = *((const vec_float4*) ((uintptr_t) inputBaseT + si_to_uint((vec_char16) jointOfs2)));
		const vec_float4 lt3 = *((const vec_float4*) ((uintptr_t) inputBaseT + si_to_uint((vec_char16) jointOfs3)));
		const vec_float4 ls0 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) jointOfs0)));
		const vec_float4 ls1 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) jointOfs1)));
		const vec_float4 ls2 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) jointOfs2)));
		const vec_float4 ls3 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) jointOfs3)));

		// Local Parent Scale (lqx)
		const vec_float4 lps0 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) parentOfs0)));
		const vec_float4 lps1 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) parentOfs1)));
		const vec_float4 lps2 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) parentOfs2)));
		const vec_float4 lps3 = *((const vec_float4*) ((uintptr_t) inputBaseS + si_to_uint((vec_char16) parentOfs3)));
		...
		vec_float4 world0Col0 = *((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) parentOfs0)));
		vec_float4 world1Col0 = *((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) parentOfs1)));
		vec_float4 world2Col0 = *((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) parentOfs2)));
		vec_float4 world3Col0 = *((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) parentOfs3)));
		vec_float4 world0Col1 = *((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) parentOfs0)));
		vec_float4 world1Col1 = *((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) parentOfs1)));
		vec_float4 world2Col1 = *((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) parentOfs2)));
		vec_float4 world3Col1 = *((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) parentOfs3)));
		vec_float4 world0Col2 = *((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) parentOfs0)));
		vec_float4 world1Col2 = *((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) parentOfs1)));
		vec_float4 world2Col2 = *((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) parentOfs2)));
		vec_float4 world3Col2 = *((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) parentOfs3)));
		...
		SHUFFLE_PACK4( world0Col0, world1Col0, world2Col0, world3Col0, world_m00, world_m10, world_m20, world_tx );
		SHUFFLE_PACK4( world0Col1, world1Col1, world2Col1, world3Col1, world_m01, world_m11, world_m21, world_ty );
		SHUFFLE_PACK4( world0Col2, world1Col2, world2Col2, world3Col2, world_m02, world_m12, world_m22, world_tz );
		...
		// Deswizzle Matrices
		SHUFFLE_PACK4( world_m00_t, world_m10_t, world_m20_t, world_tx, world0Col0, world1Col0, world2Col0, world3Col0 );
		SHUFFLE_PACK4( world_m01_t, world_m11_t, world_m21_t, world_ty, world0Col1, world1Col1, world2Col1, world3Col1 );
		SHUFFLE_PACK4( world_m02_t, world_m12_t, world_m22_t, world_tz, world0Col2, world1Col2, world2Col2, world3Col2 );

		// Output
		*((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) jointOfs0))) = world0Col0;
		*((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) jointOfs1))) = world1Col0;
		*((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) jointOfs2))) = world2Col0;
		*((vec_float4*) ((uintptr_t) outputBaseX + si_to_uint((vec_char16) jointOfs3))) = world3Col0;

		*((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) jointOfs0))) = world0Col1;
		*((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) jointOfs1))) = world1Col1;
		*((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) jointOfs2))) = world2Col1;
		*((vec_float4*) ((uintptr_t) outputBaseY + si_to_uint((vec_char16) jointOfs3))) = world3Col1;

		*((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) jointOfs0))) = world0Col2;
		*((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) jointOfs1))) = world1Col2;
		*((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) jointOfs2))) = world2Col2;
		*((vec_float4*) ((uintptr_t) outputBaseZ + si_to_uint((vec_char16) jointOfs3))) = world3Col2;
	}
}