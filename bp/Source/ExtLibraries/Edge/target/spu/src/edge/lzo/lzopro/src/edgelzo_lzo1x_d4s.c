/* lzo1x_d4s.c -- LZO1X decompression with overrun testing
...
#include "edgelzo_lzo_conf.h"
#include "lzo/lzopro/edgelzo_lzo1x.h"

#define LZO_TEST_OVERRUN
#include "edgelzo_lzo1_d.ch"

#define DO_DECOMPRESS       lzopro_lzo1x_decompress_safe
#include "edgelzo_plzo1x_d.ch"
