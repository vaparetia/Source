/* edgelzo_lzo1x.h -- public interface of the LZO1X compression algorithm
...
#define __LZOPRO_LZO1X_H_INCLUDED

#ifndef __LZOCONF_H_INCLUDED
#include "edgelzo_lzoconf.h"
#endif
...
LZO_EXTERN(int)
lzopro_lzo1x_1_14_compress_asm  ( const lzo_bytep src, lzo_uint  src_len,
                                        lzo_bytep dst, lzo_uintp dst_len,
                                        lzo_voidp wrkmem );
