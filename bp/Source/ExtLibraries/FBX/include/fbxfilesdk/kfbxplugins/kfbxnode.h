...
#include <fbxfilesdk/fbxfilesdk_nsbegin.h>
    ...
    /** Represents an element in the scene graph. A scene graph is a tree of KFbxNodes 
	  ...
	  * is the responsabilty of the caller to make sure that it does not generate cyclic 
    ...
    class KFBX_DLL KFbxNode : public KFbxObject
    {
        ...
        /**
		  ...
		  * added to change the defaul behaviour. 
		  *
        ...
        //@{
            /** Set visibility.
			  ...
			  * \remarks For backward compatibility reasons, this method will also change the 
			  *          value of the Show property. This method expects to work with a valid 
			  *          Visibility property. The value of this property will be set to either
			  *          0 or 1 depending on the \e pIsVisible value.
              */
            void SetVisibility(bool pIsVisible);

            /** Get the current value of the Visibility property.
              * \return \c false if the Visibility property value is 0.0 and \c true for any other 
			  * \remarks This method expects the Visibility property to exist and be valid. If this 
        ...
        //@{
            ...
            /** Remove the node attribute, specified by the connection index, from the connection 
			  ...
			  *          the connection list will become the new default node attribue. And if there 
        ...
        //@{
            ...
            /** This is an utility method to alter the value of the Visibility property that
			  * automatically checks for the validity of the property before attempting to 
			  * set the value. The exact same result could be achieved by the following code:
			  * \code
			  ...
			  * \endcode
              * \param pVisibility Altough the argument is a double and its value is not checked for invalid
			  *                    values, the FBX SDK assumes it will be a value in the range [0.0 - 1.0]. A value
			  *                    of 0.0 means invisible and anything else means visible.
              * \remarks This parameter is only effective if node visibility has been enabled with a 
			  *          call to KFbxNode::SetVisibility().
              */
            void SetDefaultVisibility(double pVisibility);

            /** This is an utility method to access the value of the Visibility property that automatically
			  * checks for the validity of this property. The exact same result could be achieved by the following
			  * code:
			  * \code
			  * KFbxNode* node; // we suppose this is a valid pointer
			  ...
			  * \endcode
              * \return The actual value stored in the Visibility property. 
              * \remarks This parameter is only effective if node visibility has been enabled with a
              *          call to KFbxNode::SetVisibility().
              */
        ...
        /**
		  ...
		  *
		  * The geometric tansformation (Gt * Gr * Gs) is applied only to the node attribute and after 
        ...
        //@{
            ...
            /** Change the state of the pivot context.
              ...
              * \param pPivotState The new state of the pivot contenxt.
              */
            ...
            /** Reset all the pivot sets to the default pivot context and convert the animation.
              ...
              * \remarks The \e pForceResetLimits flag has a destructive behaviour and should be used only in very 
        ...
        /**
          * \name Access to translation, rotation and scaling local and global vectors.
		  * This whole section contains deprecated functions. All these values should be retrieved from 
		  * the Evaluator (KFbxEvaluator) object connected to the scene to guarantee that the animation
		  * layers are taken into account. 
		  * To get the Local translation vector:
		  * \code
		  *	KFbxVector4 lVector = lScene->GetEvaluator()->GetNodeLocalTransform(node).GetT();
		  * \endcode
		  * The rotation and scaling vectors can be retrieved in the same way by replacing the call \e GetT() with
		  * \e GetR() and \e GetS() respectively.
          */
        //@{
        ...
        //@{
            ...
            *
            * To access this property do: Weight.Get().
            * To set this property do: Weight.Set(fbxDouble1).
            *
            */
            ...
            *
            * To access this property do: PoleVector.Get().
            * To set this property do: PoleVector.Set(fbxDouble3).
            *
            */
            ...
            *
            * To access this property do: Twist.Get().
            * To set this property do: Twist.Set(fbxDouble1).
            *
            */
            ...
            *
            * To access this property do: WorldUpVector.Get().
            * To set this property do: WorldUpVector.Set(fbxDouble3).
            *
            */
            ...
            *
            * To access this property do: AimVector.Get().
            * To set this property do: AimVector.Set(fbxDouble3).
            *
            */
            ...
            * To set this property do: QuaternionInterpolate.Set(fbxBool1).
			*
        ...
        public:
            ...
            *   \remarks  this does not clone the node's attribute.
            */
        ...
        protected:
            ...
            void    Reset();
            bool    GetAnimationIntervalRecursive(KTime& pStart, KTime& pStop, KFbxAnimLayer* pAnimLayer);
