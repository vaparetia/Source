...
public:
    ...
    /** Begins the process of adding a polygon to the mesh. 
      ...
      * This was the default behaviour of earlier versions of the FBX SDK. Since version 2010, 
    ...
    */
    ...
    /** Get the current group ID of the specified polygon.
	  ...
	  * FBX SDK does not use this information internally but guarantee its persitence in the FBX files and 
	  * in memory.
      * \param pPolygonIndex Index of the polygon.
...
protected:
    ...
    bool IsBadPoly(int pPolygonIndex) const;
