    ...
    class KFBX_DLL KFbxProperty : private FbxPropertyFlags
    {
        ...
        //@{
            ...
            /** Returns the KFCurveNode of the property from a take.
              ...
              * \remarks The returned pointer is not persistent and should not be stored for
              *         later use.
              */
            K_DEPRECATED
            ...
            /** Tries to get the KFCurve of the specified channel from the current take.
              ...
              * \remarks This method fails if the KFCurveNode does not exist.
             ...
             */
            K_DEPRECATED
            KFCurve* GetKFCurve(const char* pChannel = NULL, bool pCreateAsNeeded=true);
            ...
            /** Tries to get the KFCurve of the specified channel from the given take.
              ...
              * \param pCreateAsNeeded Creates a KFCurve if not found.
             ...
             */
            K_DEPRECATED
            KFCurve* GetKFCurve(const char* pChannel, const char* pTakeName, bool pCreateAsNeeded=true);
        //@}
