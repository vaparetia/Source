...
{
public:
    /** \enum AEClass   Category of the accumulator entry.   
    * - \e eAE_ERROR
    * - \e eAE_WARNING
    * - \e eAE_INFO
    * - \e eAE_ANY
...
public:
    ...
    /** \enum AEid
    * - \e eBINDPOSE_INVALIDOBJECT
    * - \e eBINDPOSE_INVALIDROOT
    * - \e eBINDPOSE_NOTALLANCESTORS_NODES
    * - \e eBINDPOSE_NOTALLDEFORMING_NODES
    * - \e eBINDPOSE_NOTALLANCESTORS_DEFNODES
    * - \e eBINDPOSE_RELATIVEMATRIX
    * - \e eFILE_IO_NOTIFICATION
    * - \e eFILE_IO_NOTIFICATION_MATERIAL
    * - \e eFILE_IO_NOTIFICATION_DXF_NOT_SUPPORT_NURBS
    * - \e eAE_START_ID
    */
    enum AEid {
    ...
    //@{
    /** \enum OutputSource      
    * - \e eACCUMULATOR_ENTRY
    * - \e eSEQUENCED_DETAILS
    */
    enum OutputSource {
        eACCUMULATOR_ENTRY,
        eSEQUENCED_DETAILS
