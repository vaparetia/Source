...
/** This class for FBX animation curve keys implements the interface KFbxAnimCurveKeyImpl.
  * \nosubgrouping
  * This class encapsulates the KFCurveKey
  * structure.
  */
...
public:
    ...
    * \return Time at which the key is occuring.
    */
...
/** This class is an implementation for the FBX animation curves interface KFbxAnimCurve.
  * \nosubgrouping
  * This class encapsulates the KFCurve structure.
  */
...
public:
	    ...
	    * Function KbxAnimCurveKFCurve::KeyModifyBegin() must have been called prior to modifying the keys.
        *         the keys.
        */
        void KeyModifyEnd ();
