...
/** Class for clusters (links). 
  ...
  *
  * A cluster is usually part of a skin (see KFbxDeformer, KFbxSkin). For exemple,
...
public:
    ...
    /** Set the array size for both arrays: the array of control point indices and the array of weights.
