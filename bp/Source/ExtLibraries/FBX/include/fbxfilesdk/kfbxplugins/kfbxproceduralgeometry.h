...
protected:
	...
	/** Creates a clone of this object.
      * \param pContainer           The object, typically a document or scene, that contains the new clone (can be \c NULL).
      * \param pCloneType           The type of clone to be created (Surface, Reference, or Deep clone).
      * \return                     The new clone, or \c NULL, if the specified clone type is not supported.
      */
