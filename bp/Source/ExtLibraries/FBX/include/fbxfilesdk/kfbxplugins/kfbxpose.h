...
public:
        ...
        /** Pose identifier flag.
         ...
         /** Stores the pose transformation for the given node.
           ...
           * \param pMultipleBindPose Flag to indicate if multiple bind pose exist. If this is false, 
                                      all matrix for one node should be same in different bind pose.
        ...
        //@{
          ...
          enum KNameComponent {
              ...
              //! use both initial and current name when compare two nodes, it's true if one or both matched
