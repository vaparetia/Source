...
public:
    ...
    RedBack_IteratorType const& operator--()
    {
        ...
        RecordType* lRecord = mRecord->Predecessor();
        mRecord = lRecord;
        return *this;
    }
...
public:
    ...
    RedBack_ConstIteratorType const& operator--()
    {
        ...
        RecordType const* lRecord = mRecord->Predecessor();
        mRecord = lRecord;
        return *this;
    }
...
#if defined(KARCH_DEV_MSC) // Microsoft compiler
    #if (_MSC_VER <= 1200) // VC6
        friend  KRedBlackTree<DATA_TYPE, KEY_COMPARE_FUNCTOR, ALLOCATOR>;
    #endif
#endif
    };
