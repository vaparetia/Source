...
#include <fbxfilesdk/fbxfilesdk_nsbegin.h>
    ...
    #define KFBX_UTF8_to_WIDECHAR( inUTF8,out_UTF8_to_WIDECHAR ) \
        ...
        if((char*)inUTF8 != NULL) { \
            ...
            MultiByteToWideChar( CP_UTF8, 0, inUTF8, -1, out_UTF8_to_WIDECHAR, (int)((strlen((char*)inUTF8) + 1) * sizeof(wchar_t)) ); \
        }
    ...
    #define KFBX_WIDECHAR_to_UTF8( inWideChar,out_WIDECHAR_to_UTF8 )  \
        ...
        if((wchar_t*)inWideChar != NULL) { \
            out_WIDECHAR_to_UTF8 = (char *) FbxSdkMalloc((wcslen((wchar_t *)inWideChar)+1) * 2); \
            out_WIDECHAR_to_UTF8##PointerFreeGuard.SetPointer((void*) out_WIDECHAR_to_UTF8);\
            WideCharToMultiByte( CP_UTF8,0,inWideChar,-1,out_WIDECHAR_to_UTF8, (int)((wcslen((wchar_t *)inWideChar)+1) * 2),NULL,NULL); \
        }
    ...
    #define KFBX_WIDECHAR_to_ANSI( inWideChar,out_WIDECHAR_to_ANSI )  \
        ...
        if((wchar_t*)inWideChar != NULL) { \
            out_WIDECHAR_to_ANSI = (char *) FbxSdkMalloc((wcslen((wchar_t *)inWideChar)+1) * 2); \
            out_WIDECHAR_to_ANSI##PointerFreeGuard.SetPointer((void*) out_WIDECHAR_to_ANSI); \
            WideCharToMultiByte( CP_ACP,0,inWideChar,-1,out_WIDECHAR_to_ANSI,(int)((wcslen((wchar_t *)inWideChar)+1) * 2),NULL,NULL); \
        }
    ...
    #define KFBX_ANSI_to_WIDECHAR( inANSI,out_ANSI_to_WIDECHAR ) \
        ...
        if((char*)inANSI != NULL) { \
            ...
            MultiByteToWideChar( CP_ACP, 0, inANSI, -1, out_ANSI_to_WIDECHAR, (int)((strlen((char*)inANSI) + 1) * sizeof(wchar_t)) ); \
        }

    #define KFBX_ANSI_to_UTF8( inANSI,outUTF8 ) { \
    if((char*)inANSI != NULL){ \
        wchar_t* temp_ANSI_to_UTF8_WideChar = (wchar_t *)FbxSdkMalloc((strlen((char*)inANSI)+1) * sizeof(wchar_t)); \
        MultiByteToWideChar( CP_ACP, 0, inANSI, -1, temp_ANSI_to_UTF8_WideChar, (int)((strlen((char*)inANSI)+1) * sizeof(wchar_t))); \
        WideCharToMultiByte( CP_UTF8, 0, temp_ANSI_to_UTF8_WideChar, -1, outUTF8, (int)((wcslen((wchar_t *)temp_ANSI_to_UTF8_WideChar)+1) * 2), NULL, NULL);\
        FbxSdkFree(temp_ANSI_to_UTF8_WideChar);}\
        }

    #define KFBX_UTF8_to_ANSI( inUTF8,outANSI ) { \
    if((char*)inUTF8 != NULL){ \
        wchar_t* temp_UTF8_to_ANSI_WideChar = (wchar_t *)FbxSdkMalloc((strlen((char*)inUTF8)+1) * sizeof(wchar_t));\
        MultiByteToWideChar( CP_UTF8, 0, inUTF8, -1, temp_UTF8_to_ANSI_WideChar, (int)((strlen((char*)inUTF8)+1) * sizeof(wchar_t))); \
        WideCharToMultiByte( CP_ACP, 0, temp_UTF8_to_ANSI_WideChar, -1, outANSI, (int)((wcslen((wchar_t *)temp_UTF8_to_ANSI_WideChar)+1) * 2), NULL, NULL);\
...
#ifdef _DEBUG
	const char*		mDEBUG_String;
	size_t	        mDEBUG_StringLength;
#endif
};
