/*
	vs02a_common.gcl
	2002/06/26 T.Ohtani
	$Id: vs02a_common.h,v 1.1 2002/06/27 01:09:08 usr13731 Exp $
*/
...
proc カメラセット {
	...
	chara カメラ設定 ステージカメラ \
		...
		-l 2700,1500,-8000					8000,d:CAM_MAX, -1500 \
		-r 700,2048,0 \
		-f 9750 \
		-a 200 \
		-i 2 2 0 0 \
	...
	trap ca001 d:PLAYER \
		...
		-exec {
			chara カメラ設定 メインカメラ \
				-c 0 \
				-b d:CAM_MIN,d:CAM_MIN,d:CAM_MIN	d:CAM_MAX,d:CAM_MAX,d:CAM_MAX \
				-l 2700,1500,-8000 					8000,d:CAM_MAX,0 \
				-r 870,2048,0 \
				-f 9000 \
				-a 200 \
				-i 3 3 0 0 \
	...
	trap ca005 d:PLAYER \
		...
		-exec {
			chara カメラ設定 メインカメラ \
				-c 0 \
				-b d:CAM_MIN,d:CAM_MIN,d:CAM_MIN	d:CAM_MAX,d:CAM_MAX,d:CAM_MAX \
				-l 2700,1500,-10000 				8000,d:CAM_MAX,-7687 \
				-r 870,2048,0 \
				-f 9000 \
				-a 200 \
				-i 3 3 0 0 \
	...
	trap ca006 d:PLAYER \
		...
		-exec {
			chara カメラ設定 メインカメラ \
				-c 0 \
				-b d:CAM_MIN,d:CAM_MIN,d:CAM_MIN	d:CAM_MAX,d:CAM_MAX,d:CAM_MAX \
				-l 2700,1500,-10000 					8000,d:CAM_MAX,0 \
				-r 870,2048,0 \
				-f 9000 \
				-a 200 \
				-i 3 3 0 0 \
