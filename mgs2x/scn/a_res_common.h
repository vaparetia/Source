...
//	$Id: a_res_common.h,v 1.4 2002/09/08 08:41:26 usr01475 Exp $
...
//日本語版
#ifdef d:JAPANESE
#include "a_stagename_j.h"
#else
//英語版
#include "a_stagename_e.h"
#endif
...
if ( $w:言語 == d:LANG_FRENCH ){
	...
	command 常駐リソース設定 \
		-string [武器説明日本語:*] 1 [アイテム説明日本語:*] 2 [無線メッセージ日本語:*] 3 [無線相手日本語:*] 4 \
				[セーブゲームリソース日本語:*] 5 [ステージ名日本語:*] 6 [難易度名:*] 7

} else {
	command 常駐リソース設定 \
		-string [武器説明:*] 1 [アイテム説明:*] 2 [無線メッセージ:*] 3 [無線相手:*] 4 \
				[セーブゲームリソース英語:*] 5 [ステージ名:*] 6 [難易度名:*] 7
}
