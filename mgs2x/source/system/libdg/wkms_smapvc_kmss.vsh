; ＫＭＳ用(Windows版)（マルチテクスチャ＆通常ライティング）
;
; 2002/04/19  K.Takabe
; 2002/08/20  E.Takaki
; $Id: wkms_smapvc_kmss.vsh,v 1.2 2002/12/29 12:01:47 takaki Exp $
;
; r0       : 頂点0
; r1       : 頂点1
; r2       : 法線0
...
mov r7.y, c[ CV_ZERO ].y
mul	r7.x, r4.x, c[ CV_LIGHTVEC + 0 ].x				; トゥーンシェードマッピング計算
mad r7.x, r4.y, c[ CV_LIGHTVEC + 1 ].x, r7.x		; トゥーンシェードマッピング計算
mad r7.x, r4.z, c[ CV_LIGHTVEC + 2 ].x, r7.x		; トゥーンシェードマッピング計算
;mul r6.xyz, r6.xyz, c[CV_SCALE].y					; [光源計算]1/255にスケーリング
mul r11.xyzw, v3, c[ CV_CONST0 ]					; [光源計算]
mul r7.xy, r7.xy, c[ CV_TEX2_SCALE ].xy				; 
mul oD0, r6, r11									; [光源計算]頂点カラー参照
add r7.xy, r7.xy, c[ CV_TEX2_OFFSET ].xy			; 
mov oT2.w, r3.w
