...
; $Id: objawl.vsh,v 1.1.1.3 2002/11/19 11:42:15 Yoshizawa1 Exp $
;
; 平行光源    ON
; ウェイト    ON
; 点光源      ON
...
add R_TMP, c[CV_ONE].x, -V_WEIGHT.x			; r3 = 1.0f - weight
...
;mov oD0.xyz, R_TMP.xyz;
;mov oD0.xyz, V_DIFFUSE.xyz
