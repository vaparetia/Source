/*
	...
	2002/03/28 K.Takabe
	$Id: walpha.c,v 1.8 2002/12/15 15:25:13 takaki Exp $
*/
...
#else
#define FIX			D3DBLEND_SRCALPHA		// Windows版には無い...
#define INVFIX		D3DBLEND_INVSRCALPHA	// 
#endif
...
void DG_SetAlphaMode(u_long type)
{
	...
	param = (int)((int)(type) & SCE_GS_SET_ALPHA(3,3,3,3,0));
	{
	...
	if ( alpha_fix_mode ){
		DG_ConstAlpha.alpha = (DWORD)alpha << 24 ;
	}
}
