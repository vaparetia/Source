...
; 2002/03/13  K.Takabe
; 2002/08/21  E.Takaki
; $Id: woptcmf00.vsh,v 1.3 2002/09/23 07:56:38 takaki Exp $
;
; 平行光源    ON
; ウェイト    ON
; 点光源      OFF
...
add r6.x,    c[CV_ONE].x,     -R_TMP.x			; r6.x = 1.0f - weight
mul r2.xyz,  r2.xyz,          R_TMP.x			; r2 *= weight
mul r4.xyz,  r4.xyz,          R_TMP.x			; r4 *= weight
...
dp3 r5.x, r4.xyz, r4.xyz		; 法線正規化[1]
mov oPos, r3					; 座標設定
mul r6.x, r3.w, c[ CV_FOG ].x	; Fog[1]
rsq r1.x, r5.x					; 法線正規化[2]
add oFog.x, c[ CV_FOG ].y, r6.x	; Fog[Last]
