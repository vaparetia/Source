; 影投影用シェーダー(Windows 1Texture版)
;
; 2002/04/03  K.Takabe
; 2002/08/21  E.Takaki
; $Id: wshdw_wt_1tex.vsh,v 1.2 2002/09/23 07:56:39 takaki Exp $
;
...
mul R_TMP.w, c[ CV_SCALE ].z, V_WEIGHT_WIN.w	; weight正規化(1/(1 << 15))
add r1.x,    c[CV_ONE].x,     -R_TMP.w			; r1 = 1.0f - weight
...
mul r2.xyz, r2.xyz, R_TMP.w			; r2 *= weight
mul r4.xyz, r4.xyz, R_TMP.w			; r4 *= weight
