...
;
; 2002/04/03  K.Takabe
; $Id: shdw_wt.vsh,v 1.1.1.3 2002/11/19 11:42:24 Yoshizawa1 Exp $
;
...
add r1, c[CV_ONE].x, -V_WEIGHT.x		; r1 = 1.0f - weight
...
mad r2.xyz, r3.xyz, r1, r2.xyz			; r2 += r3 * (1.0f - weight)
mad r4.xyz, r5.xyz, r1, r4.xyz			; r4 += r5 * (1.0f - weight)
...
;mad oT0.xy, c[ CV_SCALE ].w, r3.w, r3.xy	; テクスチャ座標補正（オフセット）
;mov oT0.w, r3.w								; テクスチャ座標設定（Ｗ）
;mad oT1.xy, c[ CV_SCALE ].w, r3.w, r3.xy	; テクスチャ座標補正（オフセット）
;mov oT1.w, r3.w								; テクスチャ座標設定（Ｗ）
;mad oT2.xy, c[ CV_SCALE ].w, r3.w, r3.xy	; テクスチャ座標補正（オフセット）
;mov oT2.w, r3.w								; テクスチャ座標設定（Ｗ）
;mad oT3.xy, c[ CV_SCALE ].w, r3.w, r3.xy	; テクスチャ座標補正（オフセット）
;mov oT3.w, r3.w								; テクスチャ座標設定（Ｗ）
