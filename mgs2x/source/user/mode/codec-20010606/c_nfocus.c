/*
  ...
  $Id: c_nfocus.c,v 1.1.1.3 2002/11/19 11:45:04 Yoshizawa1 Exp $
*/
/*
...
void nfocusSwitch(Work * work, int sw)
{
  work->ctrl[0] = (!sw) ? 0 : 1;
}

void nfocusSetFocus(Work * work, int t, int type, int near, int far)
{
  work->ctrl[0] = 2;
  work->ctrl[1] = t;
  work->ctrl[2] = type;
