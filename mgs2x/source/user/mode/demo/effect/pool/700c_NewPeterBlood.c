...
void *NewPeterBlood_700cLaunch( int id, void *argv )
{
	Work  work ;
	Data *data = (Data *)argv ;

	extern void *NewPeterBlood( int ,FVECTOR *,FVECTOR *,float ,float ,int  ) ;
	...
	return NewPeterBlood( work.name,
	                      work.pos,
	                      work.vec,
	                      work.width,
	                      work.height,
