...
void *NewEvmHairModel_Demo_3007Launch( int id, void *argv )
{
	Work  work ;
	Data *data = (Data *)argv ;

	extern void *NewEvmHairModel_Demo( int ,int ,int ,void *,int ,FVECTOR *,SVECTOR *,float ,int ,int ,int ,int  ) ;
   ...
   BP_LE_SwapSShortArray_Inp(&data->d7, 4);
	...
	return NewEvmHairModel_Demo( work.name,
	                             work.model_name,
	                             work.sample_num,
	                             work.object,
	                             work.objnum,
