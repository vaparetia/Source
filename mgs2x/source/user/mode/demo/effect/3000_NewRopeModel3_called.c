...
void *NewRopeModel3_called_3000Launch( int id, void *argv )
{
	Work  work ;
	Data *data = (Data *)argv ;
   ...
   BP_LE_SwapSIntArray_Inp(&data->d6, 2);
   BP_LE_SwapSShortArray_Inp(&data->d6, 4);

	work.model_name = data->d0 ;
	work.sample_num = (data->d1 + ( int ) 2.000000 ) ;
	link = &data->d2 ;
