...
/*
	...
	$Id: flour_spread.c,v 1.1.1.3 2002/11/19 11:48:52 Yoshizawa1 Exp $
*/
...
#define	  SIZE_MIN		(100)
#define	  SIZE_RND		(500)
#define	  FLOUR_SPREAD_SIZE_MAX		(1500)
   ...
   if( !DG_SwitchBuffPrim2( prim ) )
   {
	...
	for(i = 0; i < N_NUM; i++){
		if( pre_uvrgbwh->a < 1 ){
			...
			(*size) += (FLOUR_SPREAD_SIZE_MAX - (*size)) * EXPAND_RATIO / 65536 ;
...
void  *NewSpreadFlour(FMATRIX *world )
{
	Work  *work ;
