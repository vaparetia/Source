#ifndef __ORGA_WEAP_H__
#define __ORGA_WEAP_H__
...
extern int  ORG_HzdSegLineCheck( HZX_SEG *seg, FVECTOR *p1, FVECTOR *p2 ) ;
extern void ORG_HzdSegReactVector( HZX_SEG *seg, FVECTOR *p ) ;
extern int  ORG_HzdCheck( HZX_GROUP_ID hzx, FVECTOR *pos, FVECTOR *pos_v,
			  float min, FVECTOR *bounce, float sphere ) ;
extern int  ORG_HzdOnlineCheck( HZX_GROUP_ID hzx, FVECTOR *pos, FVECTOR *pos_v,
