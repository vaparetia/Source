/*
  ...
  $Id: xloadst.c,v 1.1.1.3 2002/11/19 11:43:47 Yoshizawa1 Exp $
...
{	// セーブ時に呼ばれる関数
	...
	LoadGameData( &pw->data, MCMAN_FILE_KIND_SNAKE_TALES );	//// ここは変わるだろう
	return TRUE;
}
...
void *NewLoadSnakeTalesScr( int name, int where )
{	// シナリオから呼ばれる
