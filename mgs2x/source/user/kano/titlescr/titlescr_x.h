/*
	titlescr_x.h
		タイトル画面の表示マネージャー(XBOX専用)

	2002.07.11 Y.YANO
	$Id: titlescr_x.h,v 1.1.1.3 2002/11/19 11:43:42 Yoshizawa1 Exp $
*/
...
#define CODE_TOHDINSTALL		0x0095d615		/* closeMainSlant1 */
...
#define CODE_MENUHD				0x0088de24		/* menuHD */
...
#define colonCTR				0x002b4b71		/* colonCTR */
...
#define OBJ_swCTR	0x6c96d9	/* "swCTR" */
...
#define SW_ownNORM	0x8d108d	/* "ownNORMAL" */
#define SW_ownREV	0xde57c2	/* "ownREVERSE" */
#define SW_itemLINEAR	0xf9e5c	/* "itmeLENEAR" */
#define SW_itemGROUP	0x702ff	/* "itmeGROUP" */
#define SW_quickUNEQUIP	0x85b2	/* "quickUNEQUIP" */
#define SW_quickPREV	0x5aa833	/* "quickPREVIOUS" */
#define SW_ctrlTYPEA	0x335e81	/* "ctrA" */
#define SW_ctrlTYPEB	0x335e82	/* "ctrB" */
#define SW_ctrlTYPEC	0x335e83	/* "ctrC" */
#define SW_ctrlTYPED	0x335e84	/* "ctrD" */
