...
/*
	...
	$Id: gl_minilit.c,v 1.2 2002/11/25 01:54:46 Yoshizawa1 Exp $
*/
...
#define	NEAR_FADE_P_SIZE		(60.0f)
#define	NEAR_FADE_P_SIZE_MIN	(50.0f)
#define	FAR_FADE_P_SIZE			(200.0f)
#define	FAR_FADE_P_SIZE_MIN		(150.0f)
