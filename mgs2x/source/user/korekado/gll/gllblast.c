...
/*
   ...
   汎用爆発
	...
	2002/07/26 
   $Id: gllblast.c,v 1.1.1.3 2002/11/19 11:44:12 Yoshizawa1 Exp $
*/
...
/* 爆発 */
void		*NewGllBlast3( vec, side, range1, range2, damage, faint, wp, flag )
FVECTOR		*vec ;
...
void		*NewGllBlast( vec, side, range1, range2, damage, faint, wp )
FVECTOR		*vec ;
int			side, range1, range2, damage, faint, wp ;
{
    return NewGllBlast3( vec, side, range1, range2, damage, faint, wp, 0 ) ;
}

void		*NewGllBlast2( mat, side, range1, range2, damage, faint, wp )
FMATRIX		*mat ;
int		side, range1, range2, damage, faint, wp ;
{
    FVECTOR	vec ;
