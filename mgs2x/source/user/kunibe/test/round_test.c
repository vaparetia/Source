...
/*
  ...
  $Id: round_test.c,v 1.1.1.3 2002/11/19 11:44:55 Yoshizawa1 Exp $
*/
...
static int InitPacket( Work *work, DG_PRIM2 *prim, DG_TEX *tex )
{
	...
	for ( i = 0 ; i < N_PRIMS ; i++ ){
	    ...
	    angle       = rnd()*TPI;
	    uvrgbwh->w  = 500.0f * vu0_Cos( angle );
	    uvrgbwh->h  = 500.0f * vu0_Sin( angle );
...
void *NewRoundTest( int name, int map )
{
	Work	*work;
