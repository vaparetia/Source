...
/*
    ...
    $Id: bridge_smoke.c,v 1.1.1.3 2002/11/19 11:44:34 Yoshizawa1 Exp $
*/
...
static int GetResources( Work *work, FVECTOR *position )
{
    ...
    work->cnt = 0;
    work->alpha_time = irnd()%60;

    prim = work->prim = GM_MakePrim2( DG_PRIM2_RSPRT|DG_PRIM2_TEX|DG_PRIM2_ALPHA, 1, N_PRIMS );
    if ( prim == NULL ) {
	return -1;
    }
