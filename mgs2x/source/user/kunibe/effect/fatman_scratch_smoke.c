...
/*
    ...
    $Id: fatman_scratch_smoke.c,v 1.1.1.3 2002/11/19 11:44:39 Yoshizawa1 Exp $
*/
...
#define	RISING_SPEED	(1.0f)
#define	INIT_SIZE		(250.0f)
#define	LAST_SIZE		(1000.0f)
#define	ALPHA			(16.0f)
	...
	int 	*flag )
{
	...
	if ( work != NULL ) {
		...
		if ( GetResources( work, mat, vec, flag ) < 0 ) {
			GV_DestroyActor( work );
			return NULL;
		}
	}
