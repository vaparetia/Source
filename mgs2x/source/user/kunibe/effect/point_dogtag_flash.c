...
/*
  ...
  $Id: point_dogtag_flash.c,v 1.1.1.3 2002/11/19 11:44:45 Yoshizawa1 Exp $
*/
...
static void Act( Work *work )
{
    ...
    /* 位置更新 */
    _sceVu0SubVector( &shift, (FVECTOR*)DG_Chanls[0].eye.m[3], &work->pos );
    _sceVu0Normalize( &shift, &shift );
    _sceVu0ScaleVectorXYZ( &shift, &shift, SHIFT );
    _sceVu0AddVector( pos, &work->pos, &shift );	
