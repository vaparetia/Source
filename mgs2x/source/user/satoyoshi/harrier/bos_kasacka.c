...
#include "bos_kastgt.c"
#include "bos_kasmove.c"
#include "bos_kastart.c"
...
/*	説明:									*/
/********************************************************************************/
static void har_kassetgage(Kas_Work *work)
{
    /* ゲージの初期化 */
    GM_GageSet	*gs ;
    int		max, cur ;
...
/*	説明:	初期化部メイン	      						*/
/********************************************************************************/
void *NewBosKasacka( int name, int where, void *oya_work )
{
    Kas_Work *work ;
