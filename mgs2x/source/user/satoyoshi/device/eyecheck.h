/*
	eyecheck.h
	2000/07/06 H.Satoyoshi
	$Id: eyecheck.h,v 1.1.1.3 2002/11/19 11:48:16 Yoshizawa1 Exp $
*/
typedef	struct{
	SVECTOR		turn;
	SVECTOR		rot;
...
#define	SIGHT_ALERT_CYP	500	 /*補足し続ける時間*/
...
#define	CAM_SE_INT	(4*5)	/*カメラ首振りＳＥ間隔*/
#define	CAM_SE_ROT	(2)	/*SEを鳴らす角速度*/

#define	ENABLE_HENSO_CHECK	0x0000001	//変装チェックをする
//GM_NikitaPosition[ 0 ]
