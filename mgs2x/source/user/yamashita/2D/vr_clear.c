 ...
 * vr_clear - vr_clear.c
 * ＶＲクリア  *NewVRClear
 * 2002/04/15 S.Yamashita
 * $Id: vr_clear.c,v 1.5 2002/12/05 18:41:57 takaki Exp $
 */
...
#define PHASE_CLEAR_EFFECT_COUNT        (BP_AdjustTick(90))
#define PHASE_L2D_ACTION_1_COUNT        (BP_AdjustTick( 90))
#define PHASE_ITEM_SHOW_COUNT           (BP_AdjustTick( 15))
#define PHASE_ITEM_SHOW2_COUNT          (BP_AdjustTick( 45))
#define PHASE_WAIT_1_COUNT              (BP_AdjustTick(300))
#define PHASE_L2D_ACTION_2_COUNT        (BP_AdjustTick( 30))
#define PHASE_WAIT_2_COUNT              (BP_AdjustTick( 30))
#define PHASE_CLOSE_COUNT               (BP_AdjustTick( 22))
#define PHASE_CLOSE2_COUNT              (BP_AdjustTick( 45))
#define PHASE_BONUS_PICT_FADE_IN_COUNT  (BP_AdjustTick( 60))
#define PHASE_BONUS_PICT_SHOW_COUNT     (BP_AdjustTick(300))
#define PHASE_BONUS_PICT_FADE_OUT_COUNT (BP_AdjustTick( 60))
#define PHASE_END_COUNT                 (BP_AdjustTick(  1))
...
#define VRCLR_NO_PAUSE      (0x0100)	/* ポーズしない（デバッグモード） */
#define VRCLR_NO_NEXTSTAGE  (0x0200)	/* ＮＥＸＴ ＳＴＡＧＥ 項目なしモード */
#define VRCLR_YES_NEXTSTAGE (0x0400)	/* ＮＥＸＴ ＳＴＡＧＥ 項目ありモード */
#define VRCLR_NO_RETRY      (0x0800)	/* ＲＥＴＲＹ 処理をしないモード */
#define VRCLR_DONT_RESET    (0x1000)	/* コンティニュー回数・リトライ回数を初期化しない */
#define VRCLR_NO_SETSUMEI   (0x2000)	/* 説明文非表示 */
...
#define VRCLR_TIME_COUNT_SPEED    (  97)	/* タイムカウント速度 */
...
#define VRCLR_INPUT_INTERVAL      (BP_BASE_TICK())		/* 入力の制御 */

/* Ｌ２Ｄオブジェクト */
#if 0
#  ifdef AREA_EU_BP_IGNORE()
#    define L2D_FILENAME    ( 9962345)		/* vr_clear_pal */
#    define L2D_FILENAME_A  ( 4901145)		/* vr_clear_alt_pal */
#  else
#    define L2D_FILENAME    ( 7040470)		/* vr_clear */
#    define L2D_FILENAME_A  ( 9947345)		/* vr_clear_alt */
#  endif
#else
#  define L2D_FILENAME_EU    ( 9962345)		/* vr_clear_pal */
#  define L2D_FILENAME_A_EU  ( 4901145)		/* vr_clear_alt_pal */
#  define L2D_FILENAME_NOEU    ( 7040470)		/* vr_clear */
#  define L2D_FILENAME_A_NOEU  ( 9947345)		/* vr_clear_alt */
#  define L2D_FILENAME ( BP_Area_EU() ? L2D_FILENAME_EU : L2D_FILENAME_NOEU )
#  define L2D_FILENAME_A ( BP_Area_EU() ? L2D_FILENAME_A_EU : L2D_FILENAME_A_NOEU )
#endif

#define L2D_FILENAME2   ( 5646060)		/* vr_clear_trial */

#define OBJECT_VR_TRAINING   (13397873)	/* vr_missions_cleared */
#define OBJECT_VR_UNDERBAR   ( 7459358)	/* underBar_vr */
#define OBJECT_ALT_TRAINING  ( 2709455)	/* alternative_missions_cleared */
#define OBJECT_ALT_UNDERBAR  ( 3796866)	/* underBar_alt */
...
#define OBJECT_HOSHI_1       (12148447)	/* hoshi_03 */
#define OBJECT_HOSHI_2       (12148446)	/* hoshi_02 */
#define OBJECT_HOSHI_3       (12148445)	/* hoshi_01 */
/* カーソル項目 */
...
#define OBJECT_HYPHEN  (13217253)		/* hyphen */
#define OBJECT_WEAPON  ( 4843715)		/* weapons */
...
#define OBJECT_TOT_6   (15872943)		/* total_num_1000000 */
#define OBJECT_TOT_5   (16748955)		/* total_num_100000 */
#define OBJECT_TOT_4   ( 6290571)		/* total_num_10000 */
#define OBJECT_TOT_3   (14352354)		/* total_num_1000 */
#define OBJECT_TOT_2   ( 9885693)		/* total_num_100 */
#define OBJECT_TOT_1   ( 7124670)		/* total_num_10 */
//#define OBJECT_TOT_1   ( 7562676)		/* total_num_1 */
/* ランキング */
#define OBJECT_1ST     (   53972)		/* 1st */
#define OBJECT_1ST_6   ( 5651495)		/* 1st_num_1000000 */
#define OBJECT_1ST_5   (12235231)		/* 1st_num_100000 */
#define OBJECT_1ST_4   ( 8246669)		/* 1st_num_10000 */
#define OBJECT_1ST_3   (15462058)		/* 1st_num_1000 */
#define OBJECT_1ST_2   (14114675)		/* 1st_num_100 */
#define OBJECT_1ST_1   ( 2013946)		/* 1st_num_10 */
//#define OBJECT_1ST_1   ( 5305814)		/* 1st_num_1 */
#define OBJECT_2ND     (   54820)		/* 2nd */
#define OBJECT_2ND_6   ( 9124903)		/* 2nd_num_1000000 */
#define OBJECT_2ND_5   (12343775)		/* 2nd_num_100000 */
#define OBJECT_2ND_4   ( 8250061)		/* 2nd_num_10000 */
#define OBJECT_2ND_3   (15462164)		/* 2nd_num_1000 */
#define OBJECT_2ND_2   ( 2580343)		/* 2nd_num_100 */
#define OBJECT_2ND_1   ( 3750650)		/* 2nd_num_10 */
//#define OBJECT_2ND_1   ( 5360086)		/* 2nd_num_1 */
#define OBJECT_3RD     (   55972)		/* 3rd */
#define OBJECT_3RD_6   (13843495)		/* 3rd_num_1000000 */
#define OBJECT_3RD_5   (12491231)		/* 3rd_num_100000 */
#define OBJECT_3RD_4   ( 8254669)		/* 3rd_num_10000 */
#define OBJECT_3RD_3   (15462308)		/* 3rd_num_1000 */
#define OBJECT_3RD_2   (10968955)		/* 3rd_num_100 */
#define OBJECT_3RD_1   ( 6109946)		/* 3rd_num_10 */
...
#define ACTION_SETSUMEI (11950339)	/* show_setsumei					クリアコード獲得文表示 */
#define ACTION_SETSUMEI_JPN ( 7117822)	/* show_setsumei_jpn				クリアコード獲得文表示 */
#define ACTION_SETSUMEI_FRA ( 7113790)	/* show_setsumei_frn				クリアコード獲得文表示 */
#define ACTION_SETSUMEI_GRE ( 7114813)	/* show_setsumei_grm				クリアコード獲得文表示 */
#define ACTION_SETSUMEI_ITA ( 7116924)	/* show_setsumei_itl				クリアコード獲得文表示 */
#define ACTION_SETSUMEI_SPA ( 7127038)	/* show_setsumei_spn				クリアコード獲得文表示 */
...
/* ワーク */
typedef struct _vrclear_tagWORK
{
	...
	float     tex_wea2_v0;			/* <武器>テクスチャのＶ値の原点 */
...
static int _score      = -1;	/* スコア */
static int _result     = -1;	/* 結果（順位） */
static int _next_stage =  0;	/* ＮＥＸＴＳＴＡＧＥフラグ */
static int _stars      = -1;	/* 星の数 */
...
LOM_ACTLIST_DATA,	LOM_ACTLIST_00,				ACTION_FRAME_2,		1,				LOM_ACT_COUNT|LOM_ACT_HIDE,
					...
					LOM_ACTLIST_64,				ACTION_SELECT_1,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_65,				ACTION_SELECT_2,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_66,				ACTION_SELECT_1,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_JPN,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_67,				ACTION_SELECT_2,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_JPN,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_68,				ACTION_SELECT_1,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_FRA,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_69,				ACTION_SELECT_2,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_FRA,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_70,				ACTION_SELECT_1,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_GRE,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_71,				ACTION_SELECT_2,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_GRE,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_72,				ACTION_SELECT_1,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_ITA,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_73,				ACTION_SELECT_2,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_ITA,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_74,				ACTION_SELECT_1,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_SPA,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_ACTLIST_75,				ACTION_SELECT_2,	1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												ACTION_SETSUMEI_SPA,1,				LOM_ACT_COUNT|LOM_ACT_SHOW,
												LOM_DATA_END,
					LOM_DATA_END,
...
LOM_PADLIST_DATA,	LOM_PADLIST_00,				LOM_PAD_ALLACT,		OBJECT_NEXTSTAGE,	PAD_R,		LOM_EXE_CALLBACK,	CB_OBJ_NEXTSTAGE_RIGHT,	LOM_PAD_ON_SIG,
												...
												LOM_PAD_ALLACT,		OBJECT_NEXTSTAGE,	LOM_PAD_OK,		LOM_EXE_CALLBACK,	CB_OBJ_NEXTSTAGE_OK,	LOM_PAD_PRESS,
												LOM_PAD_ALLACT,		OBJECT_TRYAGAIN,	LOM_PAD_OK,		LOM_EXE_CALLBACK,	CB_OBJ_TRYAGAIN_OK,		LOM_PAD_PRESS,
												LOM_PAD_ALLACT	,	OBJECT_EXIT,		LOM_PAD_OK,		LOM_EXE_CALLBACK,	CB_OBJ_EXIT_OK,			LOM_PAD_PRESS,
												LOM_DATA_END,
 					LOM_DATA_END,
...
LOM_MODE_DATA,		LOM_MODE_00,				LOM_ACTLIST_00,				LOM_MODE_NOLIST,				LOM_MODE_NOLIST,	/* init */
					...
					LOM_MODE_64,				LOM_ACTLIST_64,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 1 -> show_setsumei */
					LOM_MODE_65,				LOM_ACTLIST_65,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 2 -> show_setsumei */
					LOM_MODE_66,				LOM_ACTLIST_66,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 1 -> show_setsumei */
					LOM_MODE_67,				LOM_ACTLIST_67,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 2 -> show_setsumei */
					LOM_MODE_68,				LOM_ACTLIST_68,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 1 -> show_setsumei */
					LOM_MODE_69,				LOM_ACTLIST_69,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 2 -> show_setsumei */
					LOM_MODE_70,				LOM_ACTLIST_70,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 1 -> show_setsumei */
					LOM_MODE_71,				LOM_ACTLIST_71,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 2 -> show_setsumei */
					LOM_MODE_72,				LOM_ACTLIST_72,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 1 -> show_setsumei */
					LOM_MODE_73,				LOM_ACTLIST_73,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 2 -> show_setsumei */
					LOM_MODE_74,				LOM_ACTLIST_74,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 1 -> show_setsumei */
					LOM_MODE_75,				LOM_ACTLIST_75,				LOM_OBJLIST_00,					LOM_PADLIST_00,		/* cursor item open 2 -> show_setsumei */
...
static char *debugmenu_items[] = {"OFF", "ON"};
static int  debugmenu_values[] = {    0,    1};
	...
	int  rate)		/* レート */
{
	...
	sprintf(buf, "%s", item);
	MENU_CreateTextTexture(work->text_work, TEXT_X(1), TEXT_Y(y), TEXT_W, TEXT_H, 0, 0, 0, buf);

	if(count < 0)
	{
		/* 結果表示モード */
		sprintf(buf, ":");
		MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(y), TEXT_W, TEXT_H, 0, 0, 0, buf);
		sprintf(buf, "= %07d", final);
		MENU_CreateTextTexture(work->text_work, TEXT_X(4), TEXT_Y(y), TEXT_W, TEXT_H, 0, 0, 0, buf);
	}
	else
	{
		/* 計算モード */
		...
		if(rate > 0)
		{
			...
			MENU_CreateTextTexture(work->text_work, TEXT_X(3), TEXT_Y(y), TEXT_W, TEXT_H, 0, 0, 0, buf);
		}
	...
	WORK *work)		/* ワーク */
{
	...
	MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(1), TEXT_W * 4, TEXT_H, 0, 0, 0, buf);
	...
	MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(2), TEXT_W * 4, TEXT_H, 0, 0, 0, buf);
	...
	MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(3), TEXT_W * 4, TEXT_H, 0, 0, 0, buf);
}
	...
	WORK *work)		/* ワーク */
{
	...
	{
		if((0 <= VR_DiscoverCount) && (VR_DiscoverCount < 3))
		{
	...
	WORK *work)		/* ワーク */
{
	...
	/* 順位 */
	sprintf(buf, "1ST");
	MENU_CreateTextTexture(work->text_work, TEXT_X(1), TEXT_Y(5), TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, ":");
	MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(5), TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, "%07d", MSN_GET_HISCORE2(VR_STAGE_ID, 1));
	MENU_CreateTextTexture(work->text_work, TEXT_X(4), TEXT_Y(5), TEXT_W, TEXT_H, 0, 0, 0, buf);

	sprintf(buf, "2ND");
	MENU_CreateTextTexture(work->text_work, TEXT_X(1), TEXT_Y(6), TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, ":");
	MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(6), TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, "%07d", MSN_GET_HISCORE2(VR_STAGE_ID, 2));
	MENU_CreateTextTexture(work->text_work, TEXT_X(4), TEXT_Y(6), TEXT_W, TEXT_H, 0, 0, 0, buf);

	sprintf(buf, "3RD");
	MENU_CreateTextTexture(work->text_work, TEXT_X(1), TEXT_Y(7), TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, ":");
	MENU_CreateTextTexture(work->text_work, TEXT_X(2), TEXT_Y(7), TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, "%07d", MSN_GET_HISCORE2(VR_STAGE_ID, 3));
	MENU_CreateTextTexture(work->text_work, TEXT_X(4), TEXT_Y(7), TEXT_W, TEXT_H, 0, 0, 0, buf);
	...
	MENU_CreateTextTexture(work->text_work, TEXT_X(3), TEXT_Y(21) - TEXT_H / 2, TEXT_W, TEXT_H, 0, 0, 0, buf);
	}
	sprintf(buf, "TRY AGAIN");
	MENU_CreateTextTexture(work->text_work, TEXT_X(4) + TEXT_W / 4, TEXT_Y(21) - TEXT_H / 2, TEXT_W, TEXT_H, 0, 0, 0, buf);
	sprintf(buf, "EXIT");
	MENU_CreateTextTexture(work->text_work, TEXT_X(5) + TEXT_W / 4, TEXT_Y(21) - TEXT_H / 2, TEXT_W, TEXT_H, 0, 0, 0, buf);
}
	...
	int  strcode1)	/* １桁目用オブジェクトの文字列コード */
{
	...
	if(strcode7 > 1)
	{
		...
		{
			/* カンスト */
			LOM_SprTex_SetU(&work->layoutman, strcode7, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			LOM_SprTex_SetU(&work->layoutman, strcode6, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			LOM_SprTex_SetU(&work->layoutman, strcode5, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			LOM_SprTex_SetU(&work->layoutman, strcode4, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			LOM_SprTex_SetU(&work->layoutman, strcode3, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			LOM_SprTex_SetU(&work->layoutman, strcode2, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			LOM_SprTex_SetU(&work->layoutman, strcode1, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
			return;
		}
		j = 1;
		i = value / 1000000;
	...
	int  value)		/* 数値 */
{
	...
	{
		/* カンスト */
		LOM_SprTex_SetU(&work->layoutman, OBJECT_TIM_6, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
		LOM_SprTex_SetU(&work->layoutman, OBJECT_TIM_5, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
		LOM_SprTex_SetU(&work->layoutman, OBJECT_TIM_4, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 5);
		LOM_SprTex_SetU(&work->layoutman, OBJECT_TIM_3, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
		LOM_SprTex_SetU(&work->layoutman, OBJECT_TIM_2, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
		LOM_SprTex_SetU(&work->layoutman, OBJECT_TIM_1, work->tex_dig_u0 + VRCLR_FONT_TEX_WIDTH * 9);
		return;
	}
	...
	WORK *work)		/* ワーク */
{
	...
	else
	{
		...
		{
			SetShow(work, OBJECT_ALT_TRAINING, 0);
			SetShow(work, OBJECT_ALT_UNDERBAR, 0);
		}
		else if(work->mission == MSN_MISSION_ALTERNATIVE)
		{
			SetShow(work, OBJECT_VR_TRAINING , 0);
			SetShow(work, OBJECT_VR_UNDERBAR , 0);
		}

		LOM_SprTex_SetV(&work->layoutman, OBJECT_MODE, work->tex_mod_v0 + VRCLR_FONT_TEX_HEIGHT * work->mode);
		...
		if((work->mode == MSN_MODE_SNEAKING) || (work->mode == MSN_MODE_WEAPON))
		{
			...
			{
				LOM_SprTex_SetV(&work->layoutman, OBJECT_WEAPON, work->tex_wea_v0 + VRCLR_FONT_TEX_HEIGHT * (work->weapon + 1));
			}
			else
			{
				LOM_SprTex_SetV(&work->layoutman, OBJECT_WEAPON, work->tex_wea_v0 + VRCLR_FONT_TEX_HEIGHT * work->weapon);
			}
		}
		else
		{
			SetShow(work, OBJECT_HYPHEN, 0);
			SetShow(work, OBJECT_WEAPON, 0);
		}

      LOM_Spr_SetWidth(&work->layoutman, OBJECT_WEAPON, 192*TARGET_ASPECT_X,0);  //BP JG - un stretch the heading
   }
	...
	WORK *work)		/* ワーク */
{
	...
	if((work->score_type == SCORE_TYPE_03) || (work->score_type == SCORE_TYPE_07) || (work->score_type == SCORE_TYPE_08))
	{
		...
		if(work->mission == MSN_MISSION_ALTERNATIVE)
		{
			...
			{
			case 3:
				SetShow(work, OBJECT_HOSHI_3, 1);
				SetShow(work, OBJECT_HOSHI_2, 1);
				SetShow(work, OBJECT_HOSHI_1, 1);
				break;
			case 2:
				SetShow(work, OBJECT_HOSHI_3, 1);
				SetShow(work, OBJECT_HOSHI_2, 1);
				SetShow(work, OBJECT_HOSHI_1, 0);
				break;
			case 1:
				SetShow(work, OBJECT_HOSHI_3, 1);
				SetShow(work, OBJECT_HOSHI_2, 0);
				SetShow(work, OBJECT_HOSHI_1, 0);
				break;
			default:
				SetShow(work, OBJECT_HOSHI_3, 0);
				SetShow(work, OBJECT_HOSHI_2, 0);
				SetShow(work, OBJECT_HOSHI_1, 0);
				break;
			}
	...
	if((work->score_type == SCORE_TYPE_02) || (work->score_type == SCORE_TYPE_03) || (work->score_type == SCORE_TYPE_04) || (work->score_type == SCORE_TYPE_06))
	{
		if     (work->phase == PHASE_M9_SHOW       ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_m92     ), 0          , work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  0); }
		else if(work->phase == PHASE_M9_COUNT      ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_m92     ), work->count, work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  0); }
		else if(work->phase == PHASE_USP_SHOW      ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Usp     ), 0          , work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  1); }
		else if(work->phase == PHASE_USP_COUNT     ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Usp     ), work->count, work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  1); }
		else if(work->phase == PHASE_SOCOM_SHOW    ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Socom   ), 0          , work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  2); }
		else if(work->phase == PHASE_SOCOM_COUNT   ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Socom   ), work->count, work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  2); }
		else if(work->phase == PHASE_AKS_SHOW      ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Aks     ), 0          , work->rate[RATE_WEAPON_RIFLE    ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  3); }
		else if(work->phase == PHASE_AKS_COUNT     ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Aks     ), work->count, work->rate[RATE_WEAPON_RIFLE    ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  3); }
		else if(work->phase == PHASE_M4_SHOW       ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_m4      ), 0          , work->rate[RATE_WEAPON_RIFLE    ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  4); }
		else if(work->phase == PHASE_M4_COUNT      ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_m4      ), work->count, work->rate[RATE_WEAPON_RIFLE    ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  4); }
		else if(work->phase == PHASE_C4_SHOW       ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_C4Bomb  ), 0          , work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  5); }
		else if(work->phase == PHASE_C4_COUNT      ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_C4Bomb  ), work->count, work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  5); }
		else if(work->phase == PHASE_CLAYMORE_SHOW ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Claymore), 0          , work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  6); }
		else if(work->phase == PHASE_CLAYMORE_COUNT) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Claymore), work->count, work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  6); }
		else if(work->phase == PHASE_GRENADE_SHOW  ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Grenade ), 0          , work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  7); }
		else if(work->phase == PHASE_GRENADE_COUNT ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Grenade ), work->count, work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  7); }
		else if(work->phase == PHASE_RGB6_SHOW     ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Rgb6    ), 0          , work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  8); }
		else if(work->phase == PHASE_RGB6_COUNT    ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Rgb6    ), work->count, work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  8); }
		else if(work->phase == PHASE_PSG1_SHOW     ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Psg1    ), 0          , work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  9); }
		else if(work->phase == PHASE_PSG1_COUNT    ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Psg1    ), work->count, work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT *  9); }
		else if(work->phase == PHASE_PSG1_T_SHOW   ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Psg1T   ), 0          , work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT * 10); }
		else if(work->phase == PHASE_PSG1_T_COUNT  ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Psg1T   ), work->count, work->rate[RATE_WEAPON_HANDGUN  ], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT * 10); }
		else if(work->phase == PHASE_STINGER_SHOW  ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Stinger ), 0          , work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT * 11); }
		else if(work->phase == PHASE_STINGER_COUNT ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Stinger ), work->count, work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT * 11); }
		else if(work->phase == PHASE_NIKITA_SHOW   ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Nikita  ), 0          , work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT * 12); }
		else if(work->phase == PHASE_NIKITA_COUNT  ) { AddWeaponTotal(work); SetWeapon(work, GM_WeaponNum(WP_Nikita  ), work->count, work->rate[RATE_WEAPON_EXPLOSIVE], 0, OBJECT_BUL_3, OBJECT_BUL_2, OBJECT_BUL_1, OBJECT_BUL_R3, OBJECT_BUL_R2, OBJECT_BUL_R1, 0, 0, OBJECT_BUL_T5, OBJECT_BUL_T4, OBJECT_BUL_T3, OBJECT_BUL_T2, OBJECT_BUL_T1); LOM_SprTex_SetV(&work->layoutman, OBJECT_BUL_WP, work->tex_wea2_v0 + VRCLR_FONT_TEX_HEIGHT * 12); }
		else
		{
	...
	if(work->score_type == SCORE_TYPE_04)
	{
		...
		SetShow(work, OBJECT_SNE_EQ, 1);
		SetShow(work, OBJECT_SNE_T5, 1);
		SetShow(work, OBJECT_SNE_T4, 1);
...
DRAW_TOTAL_2:
	...
	SetScore(work, 0, work->score[SCORE_TOTAL], 0, 2,
			0, 0, 0, 0, 0, 0, 0, OBJECT_TOT_6, OBJECT_TOT_5, OBJECT_TOT_4, OBJECT_TOT_3, OBJECT_TOT_2, OBJECT_TOT_1);
	SetSpriteColor(&work->layoutman, OBJECT_TOT_6, 1, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	SetSpriteColor(&work->layoutman, OBJECT_TOT_5, 1, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	SetSpriteColor(&work->layoutman, OBJECT_TOT_4, 1, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	SetSpriteColor(&work->layoutman, OBJECT_TOT_3, 1, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	SetSpriteColor(&work->layoutman, OBJECT_TOT_2, 1, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	SetSpriteColor(&work->layoutman, OBJECT_TOT_1, 1, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
}
	...
	WORK *work)		/* ワーク */
{
	...
	/* 順位 */
	SetCounter(work, MSN_GET_HISCORE2(VR_STAGE_ID, 1), 0, OBJECT_1ST_6, OBJECT_1ST_5, OBJECT_1ST_4, OBJECT_1ST_3, OBJECT_1ST_2, OBJECT_1ST_1);
	SetCounter(work, MSN_GET_HISCORE2(VR_STAGE_ID, 2), 0, OBJECT_2ND_6, OBJECT_2ND_5, OBJECT_2ND_4, OBJECT_2ND_3, OBJECT_2ND_2, OBJECT_2ND_1);
	SetCounter(work, MSN_GET_HISCORE2(VR_STAGE_ID, 3), 0, OBJECT_3RD_6, OBJECT_3RD_5, OBJECT_3RD_4, OBJECT_3RD_3, OBJECT_3RD_2, OBJECT_3RD_1);

	if(MSN_GET_HISCORE(VR_STAGE_ID, 1) & MSN_OVERWRITEFLAG)
	{
		if(work->result == 1) flag = 1;
		else                  flag = 0;

		SetSpriteColor(&work->layoutman, OBJECT_1ST_6, flag, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_5, flag, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_4, flag, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_3, flag, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_2, flag, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_1, flag, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
	}
	else
	{
		SetSpriteColor(&work->layoutman, OBJECT_1ST_6, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_5, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_4, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_3, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_2, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_1ST_1, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	}
	if(MSN_GET_HISCORE(VR_STAGE_ID, 2) & MSN_OVERWRITEFLAG)
	{
		if(work->result == 2) flag = 1;
		else                  flag = 0;

		SetSpriteColor(&work->layoutman, OBJECT_2ND_6, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_5, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_4, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_3, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_2, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_1, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
	}
	else
	{
		SetSpriteColor(&work->layoutman, OBJECT_2ND_6, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_5, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_4, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_3, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_2, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_2ND_1, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	}
	if(MSN_GET_HISCORE(VR_STAGE_ID, 3) & MSN_OVERWRITEFLAG)
	{
		if(work->result == 3) flag = 1;
		else                  flag = 0;

		SetSpriteColor(&work->layoutman, OBJECT_3RD_6, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_5, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_4, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_3, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_2, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_1, flag, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
	}
	else
	{
		SetSpriteColor(&work->layoutman, OBJECT_3RD_6, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_5, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_4, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_3, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_2, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
		SetSpriteColor(&work->layoutman, OBJECT_3RD_1, 0, 256, VRDEF_PLAYABL_I, VRDEF_PLAYABL_A);
	}
	/* 合計 */
	SetScore(work, 0, work->score[SCORE_TOTAL], 0, 2,
			0, 0, 0, 0, 0, 0, 0, OBJECT_TOT_6, OBJECT_TOT_5, OBJECT_TOT_4, OBJECT_TOT_3, OBJECT_TOT_2, OBJECT_TOT_1);
	...
	if(work->result == 1)
	{
		SetSpriteColor(&work->layoutman, OBJECT_TOT_6, 1, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_5, 1, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_4, 1, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_3, 1, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_2, 1, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_1, 1, 256, VRDEF_1ST_PLC_I, VRDEF_1ST_PLC_A);
	}
	else
	{
		SetSpriteColor(&work->layoutman, OBJECT_TOT_6, 1, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_5, 1, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_4, 1, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_3, 1, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_2, 1, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
		SetSpriteColor(&work->layoutman, OBJECT_TOT_1, 1, 256, VRDEF_2ND_3RD_I, VRDEF_2ND_3RD_A);
	}
	...
	WORK *work)		/* ワーク */
{
	...
	for(i = 0; i < msg_count; i++, msg++)
	{
		...
		case 1:		/* ＦＯＣＵＳ */
			...
			SetPhase(work, PHASE_CLEAR_MOTION);
...
static void VrSequence( WORK *work )
{
	...
	if ( GM_VRStatus & GM_VR_CLEAR ) {
		if ( work->clear_count == 1 ) {
			...
			clear_flag = MSN_GET_CLEARFLAG(VR_STAGE_ID) ;

			/* スコアの計算 */
			if((_score > -1) && (_result == -2))
			work->score[SCORE_MAP     ] = _score;
			else
         ...
         work->score[SCORE_M9      ] = GM_WeaponNum(WP_m92     ) * work->rate[RATE_WEAPON_HANDGUN];
			...
			work->score[SCORE_SNEAKING] = 0;
			work->score[SCORE_NO_KILL ] = (VR_KillCount == 0) ? work->rate[RATE_NO_KILL] : 0;

			work->score[SCORE_TOTAL   ] = work->score[SCORE_TIME];
			if((work->score_type == SCORE_TYPE_03) || (work->score_type == SCORE_TYPE_07) || (work->score_type == SCORE_TYPE_08))
			{
				work->score[SCORE_TOTAL   ] += work->score[SCORE_MAP];
			}
			if((work->score_type == SCORE_TYPE_02) || (work->score_type == SCORE_TYPE_03) || (work->score_type == SCORE_TYPE_04) || (work->score_type == SCORE_TYPE_06))
			{
				work->score[SCORE_TOTAL   ] += work->score[SCORE_WEAPON];
			}
			if(work->score_type == SCORE_TYPE_04)
			{
				work->score[SCORE_TOTAL   ] += work->score[SCORE_SNEAKING];
			}
			if((work->score_type == SCORE_TYPE_01) || (work->score_type == SCORE_TYPE_02) || (work->score_type == SCORE_TYPE_04))
			{
				work->score[SCORE_TOTAL   ] += work->score[SCORE_NO_KILL];
			}

			SY_PRINTF1("VR_DiscoverCount       = %d\n", VR_DiscoverCount);
			SY_PRINTF1("(3 - VR_DiscoverCount) = %d\n", (3 - VR_DiscoverCount));
			SY_PRINTF1("RATE_SNEAKING          = %d\n", work->rate[RATE_SNEAKING]);
			SY_PRINTF1("SCORE_SNEAKING         = %d\n", work->score[SCORE_SNEAKING]);
			SY_PRINTF1("VR_KillCount           = %d\n", VR_KillCount);

			/* 結果 */
			work->result = Msn_SetNewScore(VR_STAGE_ID, work->score[SCORE_TOTAL]);
         bp_trophy_vr_mission_clear(VR_STAGE_ID);

			_score  = work->score[SCORE_TOTAL];
			_result = work->result;
			...
			if(work->result == 1)
			{
				...
				if(    (work->score_type == SCORE_TYPE_04)
					&& ((0 <= VR_DiscoverCount) && (VR_DiscoverCount < 3))) tmp = 3 - VR_DiscoverCount;
				else                                                        tmp = 0;
				if(    ((work->score_type == SCORE_TYPE_01) || (work->score_type == SCORE_TYPE_02) || (work->score_type == SCORE_TYPE_04))
					&& (VR_KillCount == 0)) tmp2 = 1;
				else                        tmp2 = 0;
				Msn_Set1stClearData(VR_STAGE_ID, work->score[SCORE_TIME], work->score[SCORE_WEAPON], tmp, tmp2);
			}
			...
			if ( GM_VRStatus & GM_VR_POSE_CLEAR ) {
				...
				GM_SdSet( SNG_FOUTS_SS ) ;
			}
			/* とりあえず、１位のＢＧＭ呼んでおく */
			GM_SdSet( SE_JOUCHUU_OFF ) ;
			GM_StreamStopAll( ) ;

			if ( (work->result == 4) && !clear_flag ) {
				GM_VoxStream( work->bgmcode[ 2 ], 0 ) ;
			} else {
				GM_VoxStream( work->bgmcode[ work->result - 1 ], 0 ) ;
			}
		}
		work->clear_count++ ;
...
static void Act(
	WORK *work)		/* ワーク */
{
   //BP JG - hide the code text.
   SPR_OBJ *pTestObject;
   pTestObject = L2D_GetObject(work->layoutman.layout,0x857721);     // remove code
   if ( pTestObject ) pTestObject->sprite.pos.x = 5000;
   pTestObject = L2D_GetObject(work->layoutman.layout,0x857722);     // remove code
   if ( pTestObject ) pTestObject->sprite.pos.x = 5000;
   pTestObject = L2D_GetObject(work->layoutman.layout,0xF46512);     // move LEVEL over
   if ( pTestObject ) pTestObject->sprite.pos.x = 79;


#ifdef DEBUG_MODE
	if(no_pause == 1) work->flag |=  VRCLR_NO_PAUSE;
	else              work->flag &= ~VRCLR_NO_PAUSE;
#endif
	if(work->flag & VRCLR_INIT)
	{
		...
		LOM_SprTex_GetV(&work->layoutman, OBJECT_BUL_WP , &work->tex_wea2_v0);
		LOM_SprTex_GetU(&work->layoutman, OBJECT_LEVEL_2, &work->tex_dig_u0);
		SY_PRINTF1("mod  v0: %f\n", work->tex_mod_v0);
		SY_PRINTF1("wea  v0: %f\n", work->tex_wea_v0);
		SY_PRINTF1("wea2 v0: %f\n", work->tex_wea2_v0);
		SY_PRINTF1("dig  u0: %f\n", work->tex_dig_u0);
	 ...
	 */
	{
...
#else
			if(work->count >= VRDEF_FRAMERATE * 15)
#endif
			{
				NextPhase(work);
			}
		...
		case PHASE_CLEAR_EFFECT:
			...
			{
				/* 最終ステージフラグ */
				if     (_next_stage == 1) work->flag &= ~VRCLR_FINAL_STAGE;
				else if(_next_stage == 2) work->flag |=  VRCLR_FINAL_STAGE;
		...
		case PHASE_L2D_ACTION_1:
			...
			if ( (BP_IsPAL()==TRUE && (work->count == 8)) ||
              (BP_IsPAL()!=TRUE && (work->count == 10)) )
         {
		...
		case PHASE_TIME_COUNT:
			...
			if(work->count < VR_TIME)
			{
				...
				if(GV_PadDataDirect[0].status & PAD_OK)
					work->count += VRCLR_TIME_COUNT_SPEED * 9 - 1;
...
//				work->count += VRCLR_SCORE_COUNT_SPEED - 1;
			...
			GO_PHASE_AFTER_WEAPON:
				if(    (work->score[SCORE_M9      ] < 0)
					&& (work->score[SCORE_USP     ] < 0)
					&& (work->score[SCORE_SOCOM   ] < 0)
					&& (work->score[SCORE_AKS     ] < 0)
					&& (work->score[SCORE_M4      ] < 0)
					&& (work->score[SCORE_C4      ] < 0)
					&& (work->score[SCORE_CLAYMORE] < 0)
					&& (work->score[SCORE_GRENADE ] < 0)
					&& (work->score[SCORE_RGB6    ] < 0)
					&& (work->score[SCORE_PSG1    ] < 0)
					&& (work->score[SCORE_PSG1_T  ] < 0)
					&& (work->score[SCORE_STINGER ] < 0)
					&& (work->score[SCORE_NIKITA  ] < 0))
				{
					SPR_POS pos_spr;
					SPR_COLOR col_spr;
					...
					/* OBJECT_BUL */
					pos_spr.x = 58;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL, 248, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL, &col_spr);

					/* OBJECT_BUL_EQ */
					pos_spr.x = 409;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL_EQ, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL_EQ, 7.5f, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL_EQ, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL_EQ, &col_spr);

					/* OBJECT_BUL_T5 */
					pos_spr.x = 420;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL_T5, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL_T5, 10, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL_T5, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL_T5, &col_spr);

					/* OBJECT_BUL_T4 */
					pos_spr.x = 430;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL_T4, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL_T4, 10, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL_T4, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL_T4, &col_spr);

					/* OBJECT_BUL_T3 */
					pos_spr.x = 440;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL_T3, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL_T3, 10, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL_T3, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL_T3, &col_spr);

					/* OBJECT_BUL_T2 */
					pos_spr.x = 450;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL_T2, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL_T2, 10, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL_T2, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL_T2, &col_spr);

					/* OBJECT_BUL_T1 */
					pos_spr.x = 460;
					LOM_Spr_SetPosition(&work->layoutman, OBJECT_BUL_T1, &pos_spr, 0);
					LOM_Spr_SetWidth   (&work->layoutman, OBJECT_BUL_T1, 10, 0);
					LOM_Spr_SetHeight  (&work->layoutman, OBJECT_BUL_T1, 10, 0);
					LOM_Spr_SetColor   (&work->layoutman, OBJECT_BUL_T1, &col_spr);
				}
...
//				work->count += VRCLR_SCORE_COUNT_SPEED - 1;
		...
		case PHASE_WAIT_1:
...
#endif
			{
				...
				/* スコアチェック */
				ASSERT(work->score[SCORE_TOTAL] == _score);
		...
		case PHASE_WAIT_2:
			...
			if(work->count >= PHASE_WAIT_2_COUNT)
			{
				...
				/* カーソルを表示 */
				if((work->result == 1) && !(work->flag & VRCLR_NO_SETSUMEI))
				{
					if(((GM_Configuration2 & GM_CONFIG_REGION) >> 12) == GM_CONFIG_REGION_EU)
					{
						if(GM_Language == GM_LANG_ENGLISH)
						{
							if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_65, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
							else                               { LOM_SetCurMode(&work->layoutman, LOM_MODE_64, 1, 1, 1); }
						}
						else if(GM_Language == GM_LANG_FRENCH)
						{
							if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_69, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
							else                               { LOM_SetCurMode(&work->layoutman, LOM_MODE_68, 1, 1, 1); }
						}
						else if(GM_Language == GM_LANG_GERMANY)
						{
							if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_71, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
							else                               { LOM_SetCurMode(&work->layoutman, LOM_MODE_70, 1, 1, 1); }
						}
						else if(GM_Language == GM_LANG_ITALY)
						{
							if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_73, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
							else                               { LOM_SetCurMode(&work->layoutman, LOM_MODE_72, 1, 1, 1); }
						}
						else if(GM_Language == GM_LANG_SPANISH)
						{
							if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_75, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
							else                               { LOM_SetCurMode(&work->layoutman, LOM_MODE_74, 1, 1, 1); }
						}
						else
						{
							ASSERT(0);
					...
					else if(((GM_Configuration2 & GM_CONFIG_REGION) >> 12) == GM_CONFIG_REGION_JAPAN)
					{
						if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_67, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
						else                               { LOM_SetCurMode(&work->layoutman, LOM_MODE_66, 1, 1, 1); }
					}
					else
					{
						if(work->flag & VRCLR_FINAL_STAGE) { LOM_SetCurMode(&work->layoutman, LOM_MODE_65, 1, 1, 1); LOM_SetCurObj (&work->layoutman, OBJECT_EXIT, 1); }
		...
		case PHASE_CLOSE:
			...
			if(work->count == 1)
			{
				...
				{
					LOM_SetCurMode(&work->layoutman, LOM_MODE_39, 1, 1, 1);
				}
			}
		...
		case PHASE_END:
			if(work->count >= PHASE_END_COUNT)
			{
				if(work->flag & VRCLR_NEXT_STAGE)
				{
					GM_ExecProc(work->proc_next_stage, NULL);
				}
				else if(work->flag & VRCLR_TRY_AGAIN)
				{
					GM_ExecProc(work->proc_try_again, NULL);

					// リスタート処理
					if((work->flag & VRCLR_NO_RETRY) == 0)
					{
	...
	if((PHASE_L2D_ACTION_1 < work->phase) && (work->phase < PHASE_CLOSE))
	{
      ...
      if(work->flag & VRCLR_VRTRIAL)
		...
		else
		{
			...
			{
				LOM_Spr_GetColor(&work->layoutman, OBJECT_ALT_TRAINING, &sprcol); sprcol.a = alpha1;
				LOM_Spr_SetColor(&work->layoutman, OBJECT_ALT_TRAINING, &sprcol);
			}
		}
      ...
      if( (BP_IsPAL()==TRUE && (work->count2 % 100) == 0) ||
          (BP_IsPAL()!=TRUE && (work->count2 % 120) == 0) )
      {
			work->count2 = 0;
      }
	}
	...
	else
	{
		...
		if(work->mission == MSN_MISSION_VR)
		{
			...
			else if(work->mode == MSN_MODE_VARIETY)
			{
				...
				case MSN_PLAYER_RAIDEN:
					if(VR_STAGE_ID >= VRM_VRT_07_RAI) return 1;
					break;
				case MSN_PLAYER_NINJA:
					if(VR_STAGE_ID >= VRM_VRT_05_NIN) return 1;
					break;
				case MSN_PLAYER_SNAKE:
					if(VR_STAGE_ID >= VRM_VRT_07_SNA) return 1;
					break;
				case MSN_PLAYER_PLISKIN:
					if(VR_STAGE_ID >= VRM_VRT_05_PLI) return 1;
					break;
				case MSN_PLAYER_TUXEDO:
					if(VR_STAGE_ID >= VRM_VRT_05_TUX) return 1;
					break;
				case MSN_PLAYER_PREVIOUS:
					if(VR_STAGE_ID >= VRM_VRT_07_PRE) return 1;
					break;
				default:
					ASSERT(0);
				}
		...
		else if(work->mission == MSN_MISSION_ALTERNATIVE)
		{
			...
			else if(work->mode == MSN_MODE_PHOTOGRAPH)
			{
				...
				{
				case MSN_PLAYER_RAIDEN:
					if(VR_STAGE_ID >= ALT_PHT_06_RAI) return 1;
					break;
				case MSN_PLAYER_SNAKE:
					if(VR_STAGE_ID >= ALT_PHT_07_SNA) return 1;
					break;
				default:
					ASSERT(0);
				}
...
//	SY_PRINTF1("FREE MEMORY SIZE: %d\n", GV_GetFreeMemorySize(2));
	...
	if(name != 0)
	{
		...
		if(work->mission == MSN_MISSION_VR)
		{
			if(  !((work->score_type == SCORE_TYPE_01)
				|| (work->score_type == SCORE_TYPE_02)
				|| (work->score_type == SCORE_TYPE_03)
				|| (work->score_type == SCORE_TYPE_04)
				|| (work->score_type == SCORE_TYPE_05)
				|| (work->score_type == SCORE_TYPE_08)))
			{
				SY_PRINTF2("ScoreType[%d] is not supported in VR Mission.\n");
				ASSERT(0);
			}
		}
		else if(work->mission == MSN_MISSION_ALTERNATIVE)
		{
			if(  !((work->score_type == SCORE_TYPE_04)
				|| (work->score_type == SCORE_TYPE_05)
				|| (work->score_type == SCORE_TYPE_07)))
			{
				SY_PRINTF2("ScoreType[%d] is not supported in Alternative Mission.\n");
				ASSERT(0);
			}
		}
	...
	else
	{
		if(work->mission == MSN_MISSION_ALTERNATIVE)
		{
			if(CreateLayoutman3(&work->layoutman, L2D_FILENAME_A, 4, 0, 0, 0, 0, LOMCallback, NULL, work, VRCLR_INPUT_INTERVAL+9, VRCLR_INPUT_INTERVAL+4, LOM_INPUT_DIRECT|LOM_KEY_REP_1) == 0)
			{
				SY_PRINTF2("Create Layoutman Failed.\n");
				return 0;
			}
...
//	SY_PRINTF1("FREE MEMORY SIZE: %d\n", GV_GetFreeMemorySize(2));
	...
	/* 最終ステージ判定 */
	if(IsFinalStage(work) == 1)          work->flag |=  VRCLR_FINAL_STAGE;
	if(work->flag & VRCLR_NO_NEXTSTAGE ) work->flag |=  VRCLR_FINAL_STAGE;
	if(work->flag & VRCLR_YES_NEXTSTAGE) work->flag &= ~VRCLR_FINAL_STAGE;
	...
	if(work->flag & VRCLR_TEXT_MODE)
	{
		...
		if((work->text_work = NewTextScreenControlEx(
			VRCLR_TEXT_BUF_X, VRCLR_TEXT_BUF_Y, 240, 0x0004, 0/*bufferedTextFlag*/)) == NULL)
		{
...
command ＶＲクリア＿星の数の設定[VRCLR_SetStars] $i:星の数
 */
void VRCLR_SetStars(void)
{
	_stars = GCL_GetNextInt();
}

/*******************************************************************************
 * スコアの設定

command ＶＲクリア＿スコアの設定[VRCLR_SetScore] $i:スコア
 */
void VRCLR_SetScore(void)
{
	_score  = GCL_GetNextInt();
	_result = -2;
}
...
command ＶＲクリア＿スコアの取得[VRCLR_GetScore]
 */
int VRCLR_GetScore(void)
{
	return _score;
}
...
command ＶＲクリア＿結果の取得[VRCLR_GetResult]
 */
int VRCLR_GetResult(void)
{
	return _result;
}
...
command ＶＲクリア＿ＮＥＸＴＳＴＡＧＥなし[VRCLR_SetNoNextStage]
 */
void VRCLR_SetNoNextStage(void)
{
	_next_stage = 1;
}
...
command ＶＲクリア＿ＮＥＸＴＳＴＡＧＥあり[VRCLR_SetYesNextStage]
 */
void VRCLR_SetYesNextStage(void)
{
	_next_stage = 2;
}
