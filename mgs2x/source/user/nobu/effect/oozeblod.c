/*
	...
	$Id: oozeblod.c,v 1.1.1.3 2002/11/19 11:46:48 Yoshizawa1 Exp $
...
static int GetResources(Work *work, void* lpParam, LPMGSDEMOMODEL lpModel)
{
	...
	nScene     = ((LPDE2EFFECTOOZEBLOODDEMO)lpParam)->nScene;
	lpDGObject = (lpModel + nScene)->object.objs;

	work->nCount = ((LPDE2EFFECTOOZEBLOODDEMO)(lpParam))->nCount;

	work->lpWork = NewOozeBloodDemo(
		((LPDE2EFFECTOOZEBLOODDEMO)(lpParam))->nName,
		lpDGObject,
		((LPDE2EFFECTOOZEBLOODDEMO)(lpParam))->nModelID);
 ...
 * 登録部分
 */
void *NewDemoOozeBloodDemo(void *lpParam, LPMGSDEMOMODEL lpModel)
{
	Work *work;
