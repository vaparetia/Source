...
//----------------------------------------------------------------------------
/*
	splush_tidal_parts3.c
	落下物の水飛沫
	ストリップで曲面形成
	軽量化・短時間

	2001/04/09 S.Okajima
	$Id: splush_tidal_parts3.c,v 1.1.1.3 2002/11/19 11:47:26 Yoshizawa1 Exp $
...
座標のポインタ先を毎フレーム参照
*/
void *NewSplushTidalParts3( FVECTOR *center, FVECTOR *force, float width )
{
	Work		*work ;
