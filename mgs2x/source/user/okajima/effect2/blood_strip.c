...
/*
	...
	$Id: blood_strip.c,v 1.1.1.3 2002/11/19 11:47:17 Yoshizawa1 Exp $
*/
#ifdef PSX2
#include <sys/types.h>
#include <stdio.h>
...
extern void *NewBloodStripParts( FVECTOR *center, FVECTOR *force, float width );
...
//static float ok_debug0=1000.0f;
//static float ok_debug1=100.0f;
...
//	work->intense = &ok_debug0;
//	work->width = &ok_debug1;
...
*/
void *NewBloodStrip( FMATRIX *world, float *intense, float *width, int life )
{
	Work		*work ;
	...
	if ( work != NULL ) {
		...
		work->width = width;
		work->life = DIRECT_TICK( life ) + CHILD_LIFE;
