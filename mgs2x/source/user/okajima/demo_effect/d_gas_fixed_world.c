...
/*
	d_gas_fixed_world.c
	テクセル流し（絶対座標バージョン・位置指定型）

	2000/03/30 S.Okajima
	$Id: d_gas_fixed_world.c,v 1.1.1.3 2002/11/19 11:46:53 Yoshizawa1 Exp $
*/
...
static	void	Act( Work *work )
{
	...
	OK_Scr_Mem( work->prim->pos[ clock ],   SCR_SPACE, sizeof(FVECTOR),          N_VERTS2 * N_PRIMS2 ) ;
...
*/
void *NewSpriteFogWorld_Demo( FVECTOR *bound0, FVECTOR *bound1, FVECTOR *vec, FVECTOR *col, int tex_name, int size, int life, int mode )
{
	Work		*work ;
