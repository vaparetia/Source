...
/*
	...
	$Id: flying_smoke.c,v 1.1.1.3 2002/11/19 11:47:05 Yoshizawa1 Exp $
...
#else
#define	RGB_MIN			(16)
#define	RGB_RND_MAX		(170)
#define	RGB_RND_MIN		(128)
#define	RGB_SUB_STEP	(3)
#endif
...
#define	FADE_IN_PHASE_TIME		((float)(ALPHA))
...
//			uvrgbwh->r = ( uvrgbwh_before->r < RGB_MIN + RGB_SUB_STEP )? RGB_MIN: uvrgbwh_before->r - RGB_SUB_STEP;
//			uvrgbwh->g = uvrgbwh->r * 180 / 256;
//			uvrgbwh->b = uvrgbwh->r * 150 / 256;
		}
...
//		uvrgbwh->r = irnd() % (RGB_RND_MAX - RGB_RND_MIN) + RGB_RND_MIN;
//		uvrgbwh->g = uvrgbwh->r * 180 / 256;
//		uvrgbwh->b = uvrgbwh->r * 150 / 256;
...
life   :消滅までのフレーム数
*/
void *NewFlyingSmoke( FVECTOR *pos, FVECTOR *vector, int life )
{
	Work		*work ;
