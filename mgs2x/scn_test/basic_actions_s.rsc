/*
	...
	$Id: basic_actions_s.rsc,v 1.1 2002/02/01 06:08:31 usr01475 Exp $
...
//		'ぱなしにすれば敵を引きずって移動することもできる。'
	...
	中級３説明:
		{
			Pulsa el bot&'on L2/R2 cuando est&'es en la visi&'on
			Esquina para echar un vistazo desde la esquina.
			El enemigo te podr&'a descubrir cuando est&'es 
			mirando. Ten cuidado.
		}
...
//		'ところを敵に見つからないように注意が必要。'
	...
	中級４説明:
		{
			Pulsa el bot&'on L2/R2 en visi&'on Primera Persona
			para avanzar de lado. Pulsa los botones L2 y R2 
			al mismo tiempo para estirarte. &'Util cuando est&'es
			luchando y escondi&'endote detr&'as de objetos.
		}
...
*/
	中級８説明:
		{
			Puedes dejar de tener seleccionadas armas
			y objetos pulsando el bot&'on L2 o R2
			r&'apidamente. P&'ulsalos de nuevo para
			equiparte otra vez. &'Util con equipo de
		}
	中級８説明_1:
		{
			visi&'on Primera Persona como el Objetivo.
		}
/*
...
//		'その間に逃げることも可能。'
	...
	上級４説明:
		{
			Puedes apuntar las pistolas pulsando el bot&'on
			Arma. Pulsa al mismo tiempo el bot&'on L1 y
			podr&'as moverte mientras apuntas. Puedes
