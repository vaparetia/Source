/*
	...
	$Id: loadproc.h,v 1.1 2002/02/01 06:08:31 usr01475 Exp $
...
proc ステージ開始時処理（デモ表示） $:タイプ $:ドア名 $:移動距離 $:モーションタイプ $:表示文字 $:デモファイル名 $:表示フラグ $:終了時位置Ｘ $:終了時位置Ｙ $:終了時位置Ｚ $:終了時方向 $:終了時姿勢 {
	#if d:DEBUG_PRINT
		print 'stage_start'
	#endif
