/*
	...
	$Id: basic_actions_g.rsc,v 1.1 2002/02/01 06:08:31 usr01475 Exp $
...
//	'ああああああああああああああああああああああああ' //もぢすうものさし。
		{
			...
			nahe der Ecke, um in den Schulterblick zu wech-
			seln u. ungesehen um die Ecke zu schauen. Der
			Rechter Analog-Stick bewegt hier die Kamera.
		}
...
//		'ぱなしにすれば敵を引きずって移動することもできる。'
	...
	中級３説明:
		{
			Bei Dr&~ucken der L2/R2-Taste im Schulterblick
			sp&~ahen Sie um die Ecke. Aber Vorsicht: Beim
			Herauslehnen k&~onnen Sie bemerkt werden.
		}
...
//		'ところを敵に見つからないように注意が必要。'
	...
	中級４説明:
		{
			Bei Dr&~ucken der L2/R2-Taste in der Beobach-
			tungspersp. treten Sie zur Seite u. mit der L2-
			u. R2-Taste gleichzeitig strecken Sie sich (gut
			beim Schie&~sen geduckt hinter Objekten.)
		}
...
*/
	中級８説明:
		{
			Durch schnelles Dr&~ucken der L2- oder R2-
			Taste k&~onnen Sie Waffen u. Objekte ablegen 
			u. durch nochmaliges Dr&~ucken wieder aufnehmen.
			Praktisch f&~ur Objekte der Beobachtungsper-
		}
	中級８説明_1:
		{
			spektive wie das Zielfernrohr.
		}
...
//		'その間に逃げることも可能。'
	...
	上級４説明:
		{
			Durch Dr&~ucken der Waffentaste k&~onnen Sie mit
			der Pistole zielen. Dr&~ucken Sie dabei die L1-
			Taste, um sich beim Zielen zu bewegen. Sie 
			k&~onnen auch laufen und schie&~sen.
		}
