/*
	...
	$Id: basic_actions_i.rsc,v 1.1 2002/02/01 06:08:31 usr01475 Exp $
	...
	初級５説明:
		{
			...
			all'altro. Tieni premuto il tasto X mentre
...
//		'ぱなしにすれば敵を引きずって移動することもできる。'
	...
	中級３説明:
		{
			Premi il tasto L2/R2 nella visuale angolare
			per sbirciare dietro l'angolo. Il nemico ti
			potrebbe vedere se ti sporgi lateralmente.
			Fai attenzione.
		}
...
//		'ところを敵に見つからないように注意が必要。'
	...
	中級４説明:
		{
			Premi il tasto L2/R2 nella Visuale Soggettiva
			per muoverti lateralmente. Premi insieme i
			tasti L2 e R2 per allungarti. Efficace durante
			gli scontri a fuoco mentre ti nascondi dietro
		}
	中級４説明_1:
		{
			gli oggetti.
...
*/
	中級８説明:
		{
			Puoi deselezionare le armi e gli oggetti
			equipaggiati premendo rapidamente il tasto L2
			o R2. Premilo nuovamente per riequipaggiarli.
			Comodo per l'equipaggiamento in Visuale
		}
	中級８説明_1:
		{
			Soggettiva, come il Mirino.
		}
/*
...
//		'その間に逃げることも可能。'
	...
	上級４説明:
		{
			Puoi prendere la mira con le armi premendo il
			tasto Armi. Mentre lo fai, premi il tasto L1 e
			potrai muoverti mentre miri. Puoi anche sparare
