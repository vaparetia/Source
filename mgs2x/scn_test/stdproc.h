/*
	...
	$Id: stdproc.h,v 1.1 2002/02/01 06:08:32 usr01475 Exp $
...
proc 明るさ可変機能  $:フォグ値Ｒ $:フォグ値Ｇ $:フォグ値Ｂ $:フォグ値ニア $:フォグ値ファー $:トラップ名 $:明るさ可変機能有効高度 {

	//	トラップ内でみるためにいったん変数に渡す
	eval ($i:明るさ可変機能有効高度 = $:明るさ可変機能有効高度)
	...
	chara フォグコントローラ 霧管理 \
		...
		//	デフォルト
		$:フォグ値Ｒ $:フォグ値Ｇ $:フォグ値Ｂ \
		$:フォグ値ニア $:フォグ値ファー $:フォグ値ファー $:フォグ値ファー \
