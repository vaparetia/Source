...
// アイテムＢＯＸ定義
// 2000.6/8 S.Okajima
// $Id: item_info.h,v 1.1 2002/02/01 06:08:31 usr01475 Exp $
//
...
*/
//--------------------------------------------
proc 設置アイテム変更 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 $:変更アイテム名 {
	#if d:DEBUG_PRINT
	...
	if ( $:変更アイテム名 == なし ) {
	} else if ( $:変更アイテム名 == Ｍ９弾薬 ) {
		@弾薬_Ｍ９_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ＵＳＰ弾薬 ) {
		@弾薬_ＵＳＰ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ソコム弾薬 ) {
		@弾薬_ソコム_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == Ｍ４弾薬 ) {
		@弾薬_Ｍ４_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ＰＳＧ１弾薬 ) {
		@弾薬_ＰＳＧ１_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ＰＳＧ１−Ｔ弾薬 ) {
		@弾薬_ＰＳＧ１−Ｔ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ＲＧＢ６弾薬 ) {
		@弾薬_ＲＧＢ６_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ニキータ弾薬 ) {
		@弾薬_ニキータ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == スティンガー弾薬 ) {
		@弾薬_スティンガー_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ＡＫＳ弾薬 ) {
		@弾薬_ＡＫＳ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == Ｃ４ ) {
		@Ｃ４_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == チャフ ) {
		@チャフ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == スタン ) {
		@スタン_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == グレネード ) {
		@グレネード_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == 雑誌 ) {
		@雑誌_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == レーション ) {
		@レーション_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == 止血剤 ) {
		@止血剤_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else if ( $:変更アイテム名 == ジアゼパム ) {
		@ジアゼパム_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫
	} else {
		#if d:DEBUG_PRINT
			print 'no_item!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
			print $:変更アイテム名
...
//--------------------------------------------
// Ｍ９
proc Ｍ９_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'm9_set'
	#endif
...
// Ｍ９弾薬
proc 弾薬_Ｍ９_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'm9_amo_set'
	#endif
...
// ＵＳＰ
proc ＵＳＰ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'usp_set'
	#endif
...
// ＵＳＰ弾薬
proc 弾薬_ＵＳＰ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'usp_amo_set'
	#endif
...
proc 弾薬_ＵＳＰ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// ソコム
proc ソコム_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'socom_set'
	#endif
...
// ソコム弾薬
proc 弾薬_ソコム_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'socom_amo_set'
	#endif
...
proc 弾薬_ソコム_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// Ｍ４
proc Ｍ４_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'm4_set'
	#endif
...
// Ｍ４弾薬
proc 弾薬_Ｍ４_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'm4_amo_set'
	#endif
...
// ＰＳＧ１
proc ＰＳＧ１_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'psg1_set'
	#endif
...
// ＰＳＧ１弾薬
proc 弾薬_ＰＳＧ１_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'psg1_amo_set'
	#endif
...
proc 弾薬_ＰＳＧ１_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// ＰＳＧ１−Ｔ
proc ＰＳＧ１−Ｔ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'psg1-t_set'
	#endif
...
// ＰＳＧ１−Ｔ弾薬
proc 弾薬_ＰＳＧ１−Ｔ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
...
proc 弾薬_ＰＳＧ１−Ｔ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// ＲＧＢ６
proc ＲＧＢ６_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'rgb_set'
	#endif
...
// ＲＧＢ６弾薬
proc 弾薬_ＲＧＢ６_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'rgb_amo_set'
	#endif
...
proc 弾薬_ＲＧＢ６_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// ニキータ
proc ニキータ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'nkt_set'
	#endif
...
// ニキータ弾薬
proc 弾薬_ニキータ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'nkt_amo_set'
	#endif
...
proc 弾薬_ニキータ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// スティンガー
proc スティンガー_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'stg_set'
	#endif
...
// スティンガー弾薬
proc 弾薬_スティンガー_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'stg_amo_set'
	#endif
...
proc 弾薬_スティンガー_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// ＡＫＳ
proc ＡＫＳ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:変更アイテム名 {
	#if d:DEBUG_PRINT
		print 'aks_set'
	#endif
...
// ＡＫＳ弾薬
proc 弾薬_ＡＫＳ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'aks_amo_set'
	#endif
...
proc 弾薬_ＡＫＳ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// クレイモア
proc クレイモア_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'clm_set'
	#endif
...
// Ｃ４
proc Ｃ４_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'c4_set'
	#endif
...
// チャフ
proc チャフ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'chaff_set'
	#endif
...
// スタン
proc スタン_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'stun_set'
	#endif
...
// マイク
proc マイク_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'mic_set'
	#endif
...
// グレネード
proc グレネード_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'gre_set'
	#endif
...
// 雑誌
proc 雑誌_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'book_set'
	#endif
...
//--------------------------------------------
// レーション
proc レーション_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'ration_set'
	#endif
...
// 止血剤
proc 止血剤_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'band_set'
	#endif
...
// ジアゼパム
proc ジアゼパム_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'dzp_set'
	#endif
...
// 煙草
proc 煙草_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'tabacco_set'
	#endif
...
// 風邪薬
proc 風邪薬_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'dzp_set'
	#endif
...
// 防弾チョッキ
proc 防弾チョッキ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'bamer_set'
	#endif
...
proc 防弾チョッキ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
		print 'bamer_set'
	#endif
...
// 地雷探知器
proc 地雷探知器_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'mine_set'
	#endif
...
// センサーＢ
proc センサーＢ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'b_sens_b_set'
	#endif
...
// 振動センサー
proc 振動センサー_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'v_sens_set'
	#endif
...
proc 振動センサー_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// 暗視ゴーグル
proc 暗視ゴーグル_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'n_goggle_set'
	#endif
...
proc 暗視ゴーグル_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// サーマルゴーグル
proc サーマルゴーグル_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 't_goggle_set'
	#endif
...
proc サーマルゴーグル_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// 髭剃り
proc 髭剃り_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'shver_set'
	#endif
...
// ソコムサプレッサ
proc ソコムサプレッサ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'scm_sp_set'
	#endif
...
proc ソコムサプレッサ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// ＡＫサプレッサ
proc ＡＫサプレッサ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'ak_sp_set'
	#endif
...
proc ＡＫサプレッサ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
		print 'ak_sp_ene_set'
	#endif
...
// ＵＳＰサプレッサ
proc ＵＳＰサプレッサ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'usp_sp_set'
	#endif
...
proc ＵＳＰサプレッサ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 {
	#if d:DEBUG_PRINT
...
// デジカメ
proc デジカメ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 {
	#if d:DEBUG_PRINT
		print 'dcamera_set'
	#endif
...
// 濡れダンボール 耐久力は25がMAX
proc 濡れダンボール_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 {
	#if d:DEBUG_PRINT
		print 'cbox_wet_set'
	#endif
...
// ダンボール 耐久力は25がMAX
proc ダンボール_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 {
	#if d:DEBUG_PRINT
		print 'cbox_a_set'
	#endif
...
// ダンボールＢ 耐久力は25がMAX
proc ダンボールＢ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 {
	#if d:DEBUG_PRINT
		print 'cbox_b_set'
	#endif
...
// ダンボールＣ 耐久力は25がMAX
proc ダンボールＣ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 {
	#if d:DEBUG_PRINT
		print 'cbox_c_set'
	#endif
...
// ダンボールＤ 耐久力は25がMAX
proc ダンボールＤ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 {
	#if d:DEBUG_PRINT
		print 'cbox_d_set'
	#endif
...
// ダンボールＥ 耐久力は25がMAX
proc ダンボールＥ_初期設置 $:ボックス名 $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:水飛沫 $:耐久力 {
	#if d:DEBUG_PRINT
		print 'cbox_e_set'
	#endif
...
// ドッグタグ
proc ドッグタグ_敵兵 $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:ステータス $:ドッグタグＩＤ $:ドッグタグ名前 {

	eval($i:Ｘ座標 = $:Ｘ座標)
	eval($i:Ｙ座標 = $:Ｙ座標)
	eval($i:Ｚ座標 = $:Ｚ座標)
	
	eval($w:ドッグタグＩＤ = $:ドッグタグＩＤ);
	eval($i:ドッグタグ名前 = $:ドッグタグ名前);
...
//オルガ専用
proc ドッグタグ_オルガ $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:ステータス $:ドッグタグＩＤ $:ドッグタグ名前 {
...
//スネーク専用
proc ドッグタグ_スネーク $:マップ $:Ｘ座標 $:Ｙ座標 $:Ｚ座標 $:ステータス $:ドッグタグＩＤ $:ドッグタグ名前 {
