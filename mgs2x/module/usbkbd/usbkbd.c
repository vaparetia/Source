/*
	usbkbd.c
		USB キーボードデータ取得ドライバ
		2000/04/05 K.Uehara
	$Id: usbkbd.c,v 1.4 2001/01/17 06:12:15 usr01475 Exp $
*/
...
ModuleInfo Module = { "KCEJ_USB_KBD", 0x0101 };
...
int usbkbd_start(void)
{
	...
	printf( "USB Keyboard Driver ver.0.01\n" );
