...
namespace LayoutExtract2
{
	...
	/// 	(Single):	initializes fraction with the given Single value
	/// 	(string):	initializes fraction with the given string value
	/// 				the string can be an in the form of and integer, Single or fraction.
	...
	/// 	Fraction ToFraction(Single)
	/// 	Single ToSingle(Fraction)
	/// 	Fraction Duplicate()
	...
	/// 
	/// Overloaded Operators (overloaded for Fractions, Integers and Singles)
	/// 	Unary: -
	/// 	Binary: +,-,*,/ 
	/// 	Relational and Logical Operators: ==,!=,<,>,<=,>=
	/// 
	/// Overloaded user-defined conversions
	/// 	Implicit:	From Single/long/string to Fraction
	/// 	Explicit:	From Fraction to Single/string
	/// </summary>
	public class Fraction
	{
		...
		public Fraction(Single dDecimalValue)
		{
		...
		/// <summary>
		/// The function returns the current Fraction object as Single
		/// </summary>
		public Single ToSingle()
		{
			return ( (Single)this.Numerator/this.Denominator );
		}
		...
		public static Fraction ToFraction(string strValue)
		{
			...
			if (i==strValue.Length)		// if string is not in the form of a fraction
				// then it is Single or integer
				return ( Convert.ToSingle(strValue));
				//return ( ToFraction( Convert.ToSingle(strValue) ) );
		...
		/// </summary>
		public static Fraction ToFraction(Single dValue)
		{
			try
			{
				checked
		...
		public static Fraction operator +(Single dbl, Fraction frac1)
		{	return ( Add(frac1 , Fraction.ToFraction(dbl) ) );	}
	
		public static Fraction operator +(Fraction frac1, Single dbl)
		{	return ( Add(frac1 , Fraction.ToFraction(dbl) ) );	}
		...
		public static bool operator ==(Fraction frac1, Single dbl)
		...
		public static implicit operator Fraction(Single dNo)
		{	return new Fraction(dNo);	}
		public static implicit operator Fraction(string strNo)
		{	return new Fraction(strNo);	}

		/// <summary>
		/// overloaed user defined conversions: from fractions to Single and string
		/// </summary>
		public static explicit operator Single(Fraction frac)
		{	return frac.ToSingle();	}
