...
void MT_QuatMul( FVECTOR *res, FVECTOR *q1, FVECTOR *q2 )
{
	res->vx = q1->vw * q2->vx + q1->vx * q2->vw + q1->vy * q2->vz - q1->vz * q2->vy ;
	res->vy = q1->vw * q2->vy + q1->vy * q2->vw + q1->vz * q2->vx - q1->vx * q2->vz ;
	res->vz = q1->vw * q2->vz + q1->vz * q2->vw + q1->vx * q2->vy - q1->vy * q2->vx ;
	res->vw = q1->vw * q2->vw - q1->vx * q2->vx - q1->vy * q2->vy - q1->vz * q2->vz ;
