...
# Release the lock
    ...
    &fork( "/exports/mj001data/httpd/cgi-bin/treeact.cgi 'directive=RunTime&ext_mode=$cgi'tags{'ext_mode'}'" ) ;
}
else
{
    &fork( "/exports/mj001data/httpd/cgi-bin/treeact.cgi 'directive=RunTime&ext_mode=$cgi'tags{'ext_mode'}&cur_dir=$cgi'tags{'cur_dir'}&showdirs=$cgi'tags{'showdirs'}&comment=どなたかが更新中です。しばらく待って「バックアップ」して下さい。'" ) ;
}
