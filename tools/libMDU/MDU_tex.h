/*
   ...
   $Id: MDU_tex.h,v 1.12 2002/08/26 11:22:09 usr01363 Exp $
...
typedef	struct	{
    ...
    TIM_Appendix	*appendix ;
    unsigned char	pad[ 50 ] ; // note: had to change this from 54 because TIM_Appendix * is 4
} PCX_Header ;
...
/* BMPファイルフォーマットヘッダ */
#if !defined( _INC_CRT ) && !defined( WIN32 )
...
#ifdef HP3DPICTURE
/* Picture.c */
extern float GetAlphaAverageFromPicture(HP3DPICTURE hp3dpic);
#endif
