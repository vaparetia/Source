/*
   ...
   $Id: MDU_mdlKm42Kms.h,v 1.3 2002/04/10 02:21:43 usr04098 Exp $
...
typedef	KM4_DEF		DG_DEF ; 
typedef	KM4_MDL		DG_MDL ;
...
#undef FREAD
#undef FWRITE
enum {STRCMP,FILE_OPERATION,FREAD,CALLOC,FSEEK,FWRITE,FTELL,FILED};
...
static	int  Make_Strip(DG_MDL *mdl,NEW_OBJECT *obj,CV2_OBJ *cobj);
...
static void FreeCV2OBJS(CV2_OBJS *cobjs);
