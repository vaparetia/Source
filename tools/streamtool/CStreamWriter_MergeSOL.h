//----------------------------------------------------------------------------
// CStreamWriter_MergeSOL.h
// Merges in just the desired data from a Sons of Liberty SKU stream
//----------------------------------------------------------------------------
...
class CStreamWriter_MergeSOL : public CStreamWriter
{
public:
   CStreamWriter_MergeSOL();
...
private:
   ...
   std::list< unsigned int >  mMergePacketTypes;
   STREAM_TAG                 mCurrentSourceStreamTag;
};
