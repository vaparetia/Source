/*
	...
	2000/07/24
	$Id: fmt_demo.h,v 1.2 2001/07/31 11:32:11 usr02774 Exp $
...
typedef struct _mst_info {
	int				object_id ;		/*  */
	unsigned short	flag ;			/*  */
	unsigned char	start_joint ;	/*  */
	unsigned char	n_joints ;		/*  */
...
enum {
	MST_FLAG_POS		= 0x0001,
	MST_FLAG_ROT		= 0x0002,
	MST_FLAG_ROTS		= 0x0004,
	MST_FLAG_TRANS		= 0x0008,
	MST_FLAG_COMPROTS	= 000040,
	MST_FLAG_COMPTRANS	= 0x0080,
};
