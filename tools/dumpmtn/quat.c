...
#if 0
/* ＰＣ等への移植用 */
#define cosf(_n) cos(double(_n))
#define sinf(_n) sin(double(_n))
#define tanf(_n) tan(double(_n))
#define acosf(_n) acos(double(_n))
#define asinf(_n) asin(double(_n))
#define atanf(_n) atan(double(_n))
#define atan2f(_n,_m) atan2(double(_n),double(_m))
#define sqrtf(_m) sqrt(double(_m))
#endif
